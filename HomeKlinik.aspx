<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="HomeKlinik.aspx.cs" Inherits="eFinance.Pages.HomeKlinik1" %>
                ...
                <div class="panel">
                    <div class="panel-body" id="Tabs" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li>
                                <a href="#tab-Pasien" data-toggle="tab" role="tab">Data Pasien
                                </a>
                            </li>
                             <li>
                                <a href="#tab-stok" data-toggle="tab" role="tab">Stok Obat
                                </a>
                            </li>
                            <li>
                        ...
                        <div class="tab-content tab-content-bordered">
                            ...
                            <div class="tab-pane" id="tab-Pasien">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3">
                                            <div class="stat-panel">
                                                <div class="stat-cell bg-info valign-middle">
                                                    ...
                                                    <span class="text-lg"><strong>
                                                        <asp:Label ID="lblTotalPasien" runat="server" Text="0"></asp:Label></strong></span><br>
                                                    <span class="text-bg">
                                                        <asp:HyperLink ID="HyperLink3" runat="server" Text="TOTAL PASIEN" NavigateUrl="~/Pages/Master/View/mPasienView.aspx"></asp:HyperLink></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="stat-panel">
                                                ...
                                                <a href="Pages/Master/View/MasterDataKaryawan.aspx" class="stat-cell col-xs-5 bg-info bordered no-border-vr no-border-l no-padding valign-middle text-center text-lg">
                                                    <i class="fa fa-users"></i>&nbsp;&nbsp;<asp:Label ID="Label9" runat="server" Text="0"></asp:Label>
                                                </a>
                                                <!-- /.stat-cell -->
