<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstKursPajakView.aspx.cs" Inherits="eFinance.Pages.Master.View.MstKursPajakView" %>
                                ...
                                <div class="col-md-6">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtNoKeputusan" type="text" Enabled="false"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Tanggal Peraturan</label>
                                            <div class="col-sm-7">
                                                <asp:TextBox runat="server" CssClass="form-control date" ID="dtTgl1" type="text" Enabled="false"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Periode Pajak</label>
                                            <div class="col-sm-7">
                                                <asp:TextBox runat="server" CssClass="form-control date" ID="dtTgl2" type="text" Enabled="false"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
