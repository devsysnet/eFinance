<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisTugasView.aspx.cs" Inherits="eFinance.Pages.Master.View.MstJenisTugasView" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdGudang" DataKeyNames="JenisTugas" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdGudang_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="JenisTugas" SortExpression="kdGudang" HeaderText="Jenis Tugas" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" />
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Tugas" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox Enabled="false" ID="jenisTugas" runat="server" CssClass="form-control" Text='<%# Bind("JenisTugas") %>'></asp:TextBox>
                                                            <asp:HiddenField ID="hdnJenisTugas" runat="server" Value='<%# Bind("JenisTugas") %>' />
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
