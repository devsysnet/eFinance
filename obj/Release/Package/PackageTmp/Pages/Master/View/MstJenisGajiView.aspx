<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisGajiView.aspx.cs" Inherits="eFinance.Pages.Master.View.MstJenisGajiView" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdGudang" DataKeyNames="nama" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdGudang_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="nama" SortExpression="kdGudang" HeaderText="Jenis Gaji" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" />
                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Gaji" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtKota" Enabled="false" runat="server" CssClass="form-control" Text='<%# Bind("nama") %>'></asp:TextBox>
                                                            <asp:HiddenField ID="hdnKota" runat="server" Value='<%# Bind("nama") %>' />
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="text-center">
                                            <asp:Button runat="server" ID="btnUpdate" Visible="false" CssClass="btn btn-primary" Text="Update" OnClick="btnUpdate_Click"></asp:Button>
