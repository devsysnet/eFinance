<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisKegiatanView.aspx.cs" Inherits="eFinance.Pages.Master.View.MstJenisKegiatanView" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdAsset" SkinID="GridView" DataKeyNames="noMkegiatan" runat="server" AllowPaging="true" PageSize="10"
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                            ...
                                            <asp:BoundField DataField="namaKegiatan" SortExpression="Jenis Kegiatan" HeaderText="Jenis Kegiatan" ItemStyle-Width="15%" />
                                                    ...
                                                    <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Kegiatan" ItemStyle-Width="5%">
                                                                <ItemTemplate>
                                                                    <div class="text-center">
                                                                        <asp:TextBox ID="txtInstansi" Enabled="false" runat="server" CssClass="form-control" placeholder="Code"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Rekening" ItemStyle-Width="5%">
                                                                <ItemTemplate>
                                                                    <div class="text-center">
                                                                        <asp:TextBox ID="txtRekening" Enabled="false" runat="server" CssClass="form-control" placeholder="Code"></asp:TextBox>
