<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="lokasibarangupdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.lokasibarangupdate" %>
                            ...
                            <div class="col-sm-12">
                                <div class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <asp:HiddenField ID="hdnnoBarang" runat="server" />
                        ...
                        <asp:GridView ID="grdProdLoc" SkinID="GridView" runat="server" OnRowDataBound="grdProdLoc_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Gudang">
                                    <ItemTemplate>
                                        <div class="text-center">
                                            <asp:HiddenField ID="hdnnoBarang" runat="server" Value='<%# Bind("noLokasiBarang") %>' />
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Lokasi Gudang">
                                 ...
                                 <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Minimun Stock">
                                    <ItemTemplate>
                                        <div class="text-center">
                                             <asp:TextBox runat="server" CssClass="form-control" ID="txtMinStok"></asp:TextBox>
                                        </div>
