<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstPelanggaranUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstPelanggaranUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <script type="text/javascript">
        ...
        function CheckAllData(Checkbox) {
            var GridVwHeaderChckbox = document.getElementById("<%=grdPelanggaran.ClientID %>");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-inline">
                                    <div class="col-sm-12">
                                        <label>Search : </label>
                                        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" MaxLength="50" PlaceHolder="Jenis Pelanggaran"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdPelanggaran" DataKeyNames="noPelanggaran" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPelanggaran_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Pelanggaran" SortExpression="Pelanggaran" HeaderText="Jenis Pelanggaran" ItemStyle-Width="30%" />
                                            ...
                                            <asp:TemplateField HeaderText="EDIT" HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <a href="javascript:void()" class="btn btn-xs btn-labeled btn-primary" onclick="return EditRow('<%#Eval("noPelanggaran")%>')">Edit</a>
                                                        <%--<a href="javascript:void()" class="btn btn-xs btn-labeled btn-danger" onclick="return DeleteRow('<%#Eval("noIdentitas")%>', '<%#Eval("Identitas")%>')">Delete</a>--%>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Jenis Pelanggaran <span class="mandatory">*</span></label>
                                <div class="col-sm-3">
