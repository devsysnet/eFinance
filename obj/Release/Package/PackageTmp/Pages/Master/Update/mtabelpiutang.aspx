<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="mtabelpiutang.aspx.cs" Inherits="eFinance.Pages.Master.Update.mtabelpiutang" %>
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdkomponengaji" DataKeyNames="noHutangpiut" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdkomponengaji_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="debet" SortExpression="debet" HeaderText="COA Debet" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="kredit" SortExpression="kredit" HeaderText="COA Kredit" ItemStyle-Width="10%" />
                                            <asp:TemplateField HeaderText="EDIT" HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <a href="javascript:void()" class="btn btn-xs btn-labeled btn-primary" onclick="return EditRow('<%#Eval("noHutangpiut")%>')">Edit</a>
                                                        <%--<a href="javascript:void()" class="btn btn-xs btn-labeled btn-danger" onclick="return DeleteRow('<%#Eval("noHutangpiut")%>', '<%#Eval("komponengaji")%>')">Delete</a>--%>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">COA Debet</label>
                                <div class="col-sm-3">
                                  <asp:DropDownList ID="cbnorek" CssClass="form-control" runat="server"  Width="300"></asp:DropDownList>
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="col-sm-3 control-label">COA Kredit</label>
                                <div class="col-sm-3">
                                  <asp:DropDownList ID="cbnorek1" CssClass="form-control" runat="server"  Width="300"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
