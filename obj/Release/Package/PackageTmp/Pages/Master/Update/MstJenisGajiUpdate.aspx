<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisGajiUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstJenisGajiUpdate" %>
                                        ...
                                        <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Gaji" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtKota" runat="server" CssClass="form-control" Text='<%# Bind("nama") %>'></asp:TextBox>
