<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="mtabelpiutangupd.aspx.cs" Inherits="eFinance.Pages.Master.Update.mtabelpiutangupd" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdkomponengaji" DataKeyNames="nohutangpiut" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdkomponengaji_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="hutang" SortExpression="hutang" HeaderText="Jenis Piutang" ItemStyle-Width="30%" />
                                            <asp:BoundField DataField="ketdebet" SortExpression="ketdebet" HeaderText="COA Debet" ItemStyle-Width="50%" />
                                          <asp:BoundField DataField="ketkredit" SortExpression="ketkredit" HeaderText="COA kredit" ItemStyle-Width="50%" />
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Jenis Piutang</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                  <asp:DropDownList ID="cbnorek1" CssClass="form-control" runat="server"  Width="150"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Status <span class="mandatory">*</span></label>
                                <div class="col-sm-3">
                                    <asp:DropDownList ID="cboStatus" runat="server" CssClass="form-control" Width="80">
