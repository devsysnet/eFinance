<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstidentitasUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstidentitasUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <script type="text/javascript">
        ...
        function CheckAllData(Checkbox) {
            var GridVwHeaderChckbox = document.getElementById("<%=grdIdentitas.ClientID %>");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-inline">
                                    <div class="col-sm-12">
                                        <label>Search : </label>
                                        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" MaxLength="50" PlaceHolder="Identitas"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdIdentitas" DataKeyNames="noIdentitas" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdIdentitas_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Identitas" SortExpression="Identitas" HeaderText="CITY" ItemStyle-Width="30%" />
                                            ...
                                            <asp:TemplateField HeaderText="EDIT" HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <a href="javascript:void()" class="btn btn-xs btn-labeled btn-primary" onclick="return EditRow('<%#Eval("noIdentitas")%>')">Edit</a>
