<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="LokasiGudangUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.LokasiGudangUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <script type="text/javascript">
        ...
        function CheckAllData(Checkbox) {
            var GridVwHeaderChckbox = document.getElementById("<%=grdLokGudang.ClientID %>");
            for (var i = 1; i < GridVwHeaderChckbox.rows.length; i++) {
                GridVwHeaderChckbox.rows[i].cells[1].getElementsByTagName("INPUT")[0].checked = Checkbox.checked;
            }
        }
        function CheckAllData1(Checkbox) {
                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <asp:TextBox runat="server" CssClass="form-control" ID="txtKet" TextMode="MultiLine" placeholder="Enter Description"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="text-center">
                                            <asp:Button runat="server" ID="btnUpdate" CssClass="btn btn-primary" Text="Save" OnClick="btnUpdate_Click"></asp:Button>
                    ...
                    <asp:GridView ID="grdAddProduk" DataKeyNames="noproduct" ShowFooter="true" SkinID="GridView" runat="server" OnRowDataBound="grdAddProduk_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="1%" HeaderText="">
                                <HeaderTemplate>
                                    <div class="text-center">
                                        <asp:CheckBox ID="chkCheckAll" runat="server" CssClass="px" onclick="return CheckAllData1(this);" />
                                    </div>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div class="text-center">
