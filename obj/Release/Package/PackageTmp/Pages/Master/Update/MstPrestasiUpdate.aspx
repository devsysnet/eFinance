<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstPrestasiUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstPrestasiUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <script type="text/javascript">
        ...
        function CheckAllData(Checkbox) {
            var GridVwHeaderChckbox = document.getElementById("<%=grdPrestasi.ClientID %>");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-inline">
                                    <div class="col-sm-12">
                                        <label>Search : </label>
                                        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" MaxLength="50" PlaceHolder="Jenis Prestasi"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdPrestasi" DataKeyNames="noPrestasi" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPrestasi_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Prestasi" SortExpression="Prestasi" HeaderText="Jenis Prestasi" ItemStyle-Width="30%" />
                                            ...
                                            <asp:TemplateField HeaderText="EDIT" HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <a href="javascript:void()" class="btn btn-xs btn-labeled btn-primary" onclick="return EditRow('<%#Eval("noPrestasi")%>')">Edit</a>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Jenis Prestasi <span class="mandatory">*</span></label>
                                <div class="col-sm-3">
