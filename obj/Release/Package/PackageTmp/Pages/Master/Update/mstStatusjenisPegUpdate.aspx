<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="mstStatusjenisPegUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.mstStatusjenisPegUpdate1" %>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <ItemTemplate>
                                            <div class="form-group">
                                                <div class="form-inline">
                                                    <div class="text-center">
                                                        <asp:TextBox runat="server" Text='<%# Bind("kdrek") %>' ID="txtAccount"  CssClass="form-control" Width="120" OnTextChanged="txtAccount_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <ItemTemplate>
                                            <div class="text-left">
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Status Pegawai" ItemStyle-Width="20%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtAgama" runat="server" CssClass="form-control" Text='<%# Bind("statuspegawai") %>'></asp:TextBox>
