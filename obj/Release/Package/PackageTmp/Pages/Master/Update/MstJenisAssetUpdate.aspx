<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisAssetUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstJenisAssetUpdate" %>
                                        ...
                                        <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Asset" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtJnsAsset" runat="server" CssClass="form-control" Text='<%# Bind("Jenis") %>'></asp:TextBox>
