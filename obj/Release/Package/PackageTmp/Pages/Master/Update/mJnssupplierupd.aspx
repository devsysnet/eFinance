<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="mJnssupplierupd.aspx.cs" Inherits="eFinance.Pages.Master.Update.mJnssupplierupd" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdGudang" DataKeyNames="Jenissup" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdGudang_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Jenissup" SortExpression="kdGudang" HeaderText="Jenis Supplier" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" />
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Supplier" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtjnssupplier" runat="server" CssClass="form-control" Text='<%# Bind("Jenissup") %>'></asp:TextBox>
                                                            <asp:HiddenField ID="hdnjnssupplier" runat="server" Value='<%# Bind("Jenissup") %>' />
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
