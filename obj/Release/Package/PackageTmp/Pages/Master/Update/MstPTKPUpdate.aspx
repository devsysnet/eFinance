<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstPTKPUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstPTKPUpdate" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdPTKP" DataKeyNames="noPTKP" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPTKP_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PTKP" SortExpression="PTKP" HeaderText="PTKP" ItemStyle-Width="30%" />
                                            <asp:BoundField DataField="nilai" SortExpression="Nominal" HeaderText="Nominal" ItemStyle-Width="30%" />
                                            ...
                                            <asp:TemplateField HeaderText="EDIT" HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <a href="javascript:void()" class="btn btn-xs btn-labeled btn-primary" onclick="return EditRow('<%#Eval("noPTKP")%>')">Edit</a>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">PTKP <span class="mandatory">*</span></label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtNamaArea" runat="server" CssClass="form-control" MaxLength="50" placeholder="PTKP"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Nominal</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtNominal" runat="server" CssClass="form-control money"  MaxLength="50" placeholder="Nominal"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
