<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisKegiatanInsert.aspx.cs" Inherits="eFinance.Pages.Master.Input.MstJenisKegiatanInsert" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:Button runat="server" ID="Button1" CssClass="btn btn-success" Text="Add Jenis Kegiatan" OnClick="Button1_Click"></asp:Button>
                            </div>
                        </div>
                        <div class="col-md-3">
                        </div>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Kode Kegiatan" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox ID="txtkode" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Kegiatan" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox ID="txtInstansi" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <div class="modal-content size-sedang">
            ...
            <div class="modal-body ">
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdBrand" DataKeyNames="noMkegiatan" runat="server" SkinID="GridView" AllowPaging="true" PageSize="5" OnPageIndexChanging="grdBrand_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Jenis Kegiatan" SortExpression="kodeReagent">
                                <ItemTemplate>
                                    <asp:Label ID="lblInstansi" runat="server" Text='<%# Bind("namaKegiatan") %>'></asp:Label>
                                    <asp:HiddenField ID="hdnInstansi" runat="server" Value='<%# Eval("noMkegiatan") %>'></asp:HiddenField>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
            ...
            <div class="modal-footer">
                <div class="form-group">
                    <label for="pjs-ex1-fullname" class="col-sm-2 control-label text-right">Jenis Kegiatan :</label>
                    <div class="col-sm-9">
