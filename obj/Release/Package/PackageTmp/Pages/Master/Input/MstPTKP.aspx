<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstPTKP.aspx.cs" Inherits="eFinance.Pages.Master.Input.MstPTKP" %>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdPTKP" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="PTKP">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox ID="txtPTKP" runat="server" CssClass="form-control" MaxLength="30" placeholder="PTKP"></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
