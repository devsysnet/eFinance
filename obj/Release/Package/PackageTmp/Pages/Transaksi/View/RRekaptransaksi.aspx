<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RRekaptransaksi.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RRekaptransaksi" %>
                ...
                <asp:GridView ID="GridView1" SkinID="GridView" runat="server">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nilai Bayar" SortExpression="ptd" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="right">
                            <ItemTemplate>
                                <asp:Label ID="bayar" runat="server" Text='<%# Eval("nilaiBayar") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Nilai Diskon" SortExpression="ptd" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="right">
                          ...
                          <asp:TemplateField HeaderText="Saldo" SortExpression="ptd" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="right">
                            <ItemTemplate>
                                <asp:Label ID="saldo" runat="server" Text='<%# Eval("saldo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
