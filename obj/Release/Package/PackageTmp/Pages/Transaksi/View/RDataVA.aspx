<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RDataVA.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RDataVA" %>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <asp:DropDownList Visible="false" ID="cbotahunajaran" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cboUnit_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdSiswa" SkinID="GridView" runat="server" AllowPaging="false" PageSize="100">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Cabang" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                              ...
                                              <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Siswa" ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblnis" runat="server" Text='<%# Bind("namaSiswa") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Tgl Awal" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblnis" runat="server" Text='<%# Bind("mintgl") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Tgl Akhir" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblnis" runat="server" Text='<%# Bind("maxtgl") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="VA" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblnisn" runat="server" Text='<%# Bind("va") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Amount" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNamaSiswa" runat="server" Text='<%# Bind("amount") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
