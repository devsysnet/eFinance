<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransSuratTugasView.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.TransSuratTugasView" %>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" class="form-control" Enabled="false" ID="date"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label">Dari Tanggal</label>
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" class="form-control" ID="fromDate" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label">Sampai Tanggal</label>
                                <div class="col-sm-5">
                                    <asp:TextBox Enabled="false" runat="server" class="form-control" ID="toDate"></asp:TextBox>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:DropDownList Enabled="false" runat="server" CssClass="form-control" ID="cboUnit">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:DropDownList Enabled="false" ID="cboParent" CssClass="form-control" runat="server"></asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:DropDownList Enabled="false" runat="server" class="form-control" ID="mhs">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <asp:TextBox runat="server" Enabled="false" class="form-control " ID="deskripsi" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group row" style="margin-top:20px">
                                <div class="col-md-12">
                                    <div class="text-center">
                                        <asp:Button runat="server" Visible="false" ID="btnSimpan" CssClass="btn btn-primary" Text="Save" OnClick="btnSimpan_Click"></asp:Button>
                                        <asp:Button runat="server" ID="btnResetRek" CssClass="btn btn-danger" Text="Back" OnClick="btnResetRek_Click"></asp:Button>
                                    </div>
                                </div>
                            </div>
                        </div>
