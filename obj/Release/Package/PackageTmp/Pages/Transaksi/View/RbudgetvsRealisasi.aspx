<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RbudgetvsRealisasi.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RbudgetvsRealisasi" %>
                ...
                <asp:GridView ID="grdAccount" DataKeyNames="ket" SkinID="GridView" runat="server">
                        <Columns>
                         <asp:TemplateField HeaderText="Remark" SortExpression="Ket" ItemStyle-Width="50%" ItemStyle-HorizontalAlign="left">
                          ...
                          <asp:TemplateField HeaderText="Budget" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                          <ItemTemplate>
                          <asp:Label ID="Grup"  runat="server" Text='<%# Eval("budget") %>'></asp:Label>
                          </ItemTemplate>
                         </asp:TemplateField> 
                          <asp:TemplateField HeaderText="Realisasi" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                          <ItemTemplate>
                          <asp:Label ID="Grup"  runat="server" Text='<%# Eval("realisasi") %>'></asp:Label>
                          </ItemTemplate>
                         </asp:TemplateField>   
                           <asp:TemplateField HeaderText="Sisa Budget" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                          <ItemTemplate>
                          <asp:Label ID="Grup"  runat="server" Text='<%# Eval("sisabudget") %>'></asp:Label>
                          </ItemTemplate>
                         </asp:TemplateField>   
                        </Columns>
