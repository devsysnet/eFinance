<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Treackingjumlahsiswa.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.Treackingjumlahsiswa" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdSiswa"  SkinID="GridView" runat="server" AllowPaging="False" PageSize="100" OnPageIndexChanging="grdSiswa_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Siswa Aktif" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblnis" runat="server" Text='<%# Bind("aktif") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Siswa Non Aktif" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblkelas" runat="server" Text='<%# Bind("nonaktif") %>'>></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
