<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Ranggarandasaryayasan.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.Ranggarandasaryayasan" %>
                ...
                <div id="headprint">
                    ...
                    <h3 id="periode" style="text-align:center;color:black" runat="server"></h3>
                     ...
                     <style>
                        ...
                        <asp:Button ID="btnprintPajak" runat="server" visible="false"  CssClass="btn btn-success " Text="Print" OnClick="printPajak"/>
