<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RKasViewdetal1.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RKasViewdetal1" %>
                ...
                <asp:GridView ID="grdAccount" DataKeyNames="kdtran" SkinID="GridView" runat="server">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Description" SortExpression="ytd" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="left">
                         ...
                         <asp:TemplateField HeaderText="COA" SortExpression="ytd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="left">
                            <ItemTemplate>
                                <asp:Label ID="Jenis" runat="server" Text='<%# Eval("kdrek") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="NilaiKas" SortExpression="ytd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="left">
                            <ItemTemplate>
                                <asp:Label ID="Jenis" runat="server" Text='<%# Eval("nilaikas") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="NilaiGL" SortExpression="nilai" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                            <ItemTemplate>
                                <asp:Label ID="debet" runat="server" Text='<%# Eval("nilaigl") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
