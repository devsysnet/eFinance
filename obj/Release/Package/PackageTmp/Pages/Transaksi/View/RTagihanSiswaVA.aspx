<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RTagihanSiswaVA.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RTagihanSiswaVA" %>
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                             ...
                             <asp:TextBox ID="txtTotal" Visible="false" runat="server" CssClass="form-control money" Width="250" Enabled="false"> </asp:TextBox>
