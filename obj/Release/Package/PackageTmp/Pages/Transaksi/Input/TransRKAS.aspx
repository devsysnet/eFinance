<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransRKAS.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransRKAS" %>
                            ...
                            <div class="form-horizontal">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtJmlSiswa" runat="server" CssClass="form-control numeric"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label text-left">Jumlah Pagu <span class="mandatory">*</span></label>
                                        <div class="col-sm-5">
                                            <asp:TextBox ID="txtJmlPagu" runat="server" CssClass="form-control money" onBlur="Calculate();"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label text-left">Jumlah Tahap <span class="mandatory">*</span></label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList runat="server" ID="cboJmlTahap" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cboJmlTahap_SelectedIndexChanged">
