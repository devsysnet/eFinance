<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPelunasanAR1.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransPelunasanAR1" %>
                ...
                <div class="panel-body">
                    ...
                    <div id="tabGrid" runat="server">
                                    ...
                                    <asp:GridView ID="grdARSiswa" DataKeyNames="noSiswa" SkinID="GridView" runat="server" AllowPaging="false" PageSize="100" OnPageIndexChanging="grdARSiswa_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="10%" HeaderText="Diskon">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <asp:TextBox ID="txtDiskonD" runat="server" CssClass="form-control money" Text='<%# Bind("nilaiDisc","{0:n2}") %>' Width="100"></asp:TextBox>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="form-inline">
                                        ...
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtTotal" runat="server" Enabled="false" CssClass="form-control money" Width="160" Text="0.00"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row" id="button" runat="server">
                            <div class="col-sm-12 ">
                                <div class="text-center">
                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Simpan" OnClick="btnSubmit_Click" UseSubmitBehavior="false" />
