<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Transurattugas.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.Transurattugas" %>
                            ...
                            <div class="form-horizontal">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Tanggal Penugasan <span class="mandatory">*</span></label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Tanggal Mulai Tugas</label>
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="dtmulai" runat="server" class="form-control date col-sm-5"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Tanggal Selesai Tugas</label>
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="dtselesai" runat="server" class="form-control date col-sm-5"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
