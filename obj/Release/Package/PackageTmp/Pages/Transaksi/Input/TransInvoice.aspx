<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransInvoice.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransInvoice" %>
                            ...
                            <div class="col-sm-12 overflow-x-table">
                                <asp:GridView ID="grdSOD" SkinID="GridView" runat="server" OnSelectedIndexChanged="grdSOD_SelectedIndexChanged">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="QTY Satuan" ItemStyle-Width="6%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="QTY Satuan Besar" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                           <asp:TextBox runat="server" CssClass="form-control money" Text="0.00" ID="txtQtyBesar" onblur="return Calculate(event);"></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Satuan Besar" ItemStyle-Width="6%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:Label ID="lblUnitBesar" runat="server"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="QTY Satuan Besar1" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:TextBox runat="server" CssClass="form-control money" Text="0.00" ID="txtQtyBesar1" onblur="return Calculate(event);"></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Satuan Besar1" ItemStyle-Width="6%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:Label ID="lblUnitBesar1" runat="server"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
