<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPemusnahanAsset.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransPemusnahanAsset" %>
                    ...
                    <div class="row">
                        <div class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                        <asp:DropDownList ID="cboLokasi" runat="server" OnSelectedIndexChanged="cboLokasi_SelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group row">
