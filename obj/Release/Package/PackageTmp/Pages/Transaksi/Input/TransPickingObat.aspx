<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPickingObat.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransPickingObat" %>
                ...
                <div class="panel-body">
                    ...
                    <div id="tabForm" runat="server" visible="false">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:TextBox runat="server" CssClass="form-control" ID="dtPeriksa" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-sm-3 control-label">Berat (Kg) </label>
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtBerat" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Tinggi Badan (cm)</label>
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtTinggi" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-sm-3 control-label">Suhu Badan</label>
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtShBadan" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-sm-3 control-label">Tekanan Darah</label>
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txttekanan" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="form-horizontal">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtAnamnesa" runat="server" CssClass="form-control" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtDiagnosa" runat="server" CssClass="form-control" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtTindakan" runat="server" CssClass="form-control" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-9 overflow-x-table">
                                                        <asp:GridView ID="grdObat" SkinID="GridView" runat="server" OnRowCommand="grdObat_RowCommand">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Kode" ItemStyle-Width="8%">
                                                                    <ItemTemplate>
                                                                        <div class="form-group">
                                                                            <div class="form-inline">
                                                                                <div class="text-center">
                                                                                    ...
                                                                                    <asp:ImageButton ID="btnImgAccount" runat="server" ImageUrl="~/assets/images/icon_search.png" CssClass="btn-image form-control" Visible="false" CommandName="Select" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>' />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Obat" ItemStyle-Width="12%">
                                                                    <ItemTemplate>
                                                                        <div class="text-left">
                                                                ...
                                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Harga" ItemStyle-Width="9%">
                                                                    <ItemTemplate>
                                                                        <div class="text-left">
                                                                            <asp:TextBox runat="server" ID="txtHrg" CssClass="form-control money" onKeyUp="Calculate()" onKeyDown="Calculate()" Enabled="false"></asp:TextBox>
                                                                        </div>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Keterangan" ItemStyle-Width="12%">
                                                                    <ItemTemplate>
                                                                        <div class="text-left">
                                                                            <asp:TextBox runat="server" ID="txtKet" TextMode="MultiLine" CssClass="form-control" Enabled="false"></asp:TextBox>
                                                                        </div>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label text-right">Biaya </label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-5 text-right">
                                                                     <asp:TextBox ID="txtBiayaObat" runat="server" CssClass="form-control money" Text="0.00" onKeyUp="return Calculate(event);" onKeyDown="return Calculate(event);" Enabled="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <asp:GridView ID="grdRegisterHistory" SkinID="GridView" runat="server">
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="anamnesa" HeaderStyle-CssClass="text-center" HeaderText="Anamnesa" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                                                                <asp:BoundField DataField="diagnosa" HeaderStyle-CssClass="text-center" HeaderText="Diagnosa" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="text-center">
                                    <asp:Button runat="server" ID="btnAddRow" Visible="false" CssClass="btn btn-success" Text="Tambah Baris" OnClick="btnAddRow_Click"></asp:Button>
                ...
                <asp:HiddenField runat="server" ID="hdnParameterObat" />
                    <asp:GridView ID="grdObatDetil" SkinID="GridView" runat="server" AllowPaging="false" PageSize="10" OnSelectedIndexChanged="grdObatDetil_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundField DataField="expired" HeaderStyle-CssClass="text-center" HeaderText="Expired" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd MMM yyyy}" />
