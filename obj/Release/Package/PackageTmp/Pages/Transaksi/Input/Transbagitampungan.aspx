<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Transbagitampungan.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.Transbagitampungan" %>
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdGajiKar" DataKeyNames="notampungan" SkinID="GridView" runat="server" AllowPaging="true" PageSize="20" OnPageIndexChanging="grdGajiKar_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="nilaialokasi" HeaderText="Nilai Alokasi" ItemStyle-Width="10%" HeaderStyle-CssClass="text-center" />
                                            <asp:BoundField DataField="Saldo" HeaderText="Saldo" ItemStyle-Width="10%" HeaderStyle-CssClass="text-center" />
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label text-right">Perwakilan</label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList ID="cboCabangParent" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboCabangParent_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label text-right">Alokasi Cabang</label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList ID="cboCabang1" CssClass="form-control" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-5 control-label text-right">Saldo</label>
                                        <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdSaldoGL" DataKeyNames="norek" SkinID="GridView" runat="server" OnRowDataBound="grdSaldoGL_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                              ...
                                              <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="8%" HeaderText="Nilai">
                                                <ItemTemplate>
                                                    <div class="text-right">
                                                       <asp:TextBox runat="server" CssClass="form-control money" ID="txtDebit" Width="200" onKeyUp="Calculate()" onKeyDown="Calculate()"></asp:TextBox>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
