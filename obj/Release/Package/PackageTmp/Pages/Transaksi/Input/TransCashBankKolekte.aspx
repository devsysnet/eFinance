<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransCashBankKolekte.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransCashBankKolekte" %>
                        ...
                        <div class="form-horizontal">
                            <div class="col-sm-6">
                                ...
                                <div runat="server" id="formKolekte" visible="false">
                                 ...
                                 <div runat="server" id="divKolakte" visible="false">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Jenis Kolekte <span class="mandatory">*</span></label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList runat="server" ID="cbojnskolakte" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="divKolekte_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
