<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransGiro.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransGiro" %>
                    ...
                    <div class="row">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:DropDownList ID="cbojenistransaksi" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboLokasi_SelectedIndexChanged" Width="200">
                                 ...
                                 <div class="col-sm-3" id="showhidekode" runat="server">
                                     <asp:DropDownList runat="server" AutoPostBack="false"  CssClass="form-control" ID="cborekeningbank">                                          
                                      </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                     <asp:DropDownList runat="server" AutoPostBack="false"  CssClass="form-control" ID="cbojenissrt">                                          
                                      </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="nomorGiro"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Bank <span class="mandatory">*</span></label>
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="namabank"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" CssClass="form-control date" ID="tglGiro"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Tanggal Jatuh Tempo <span class="mandatory">*</span></label>
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" CssClass="form-control date" ID="tglJatuhTempo"></asp:TextBox>
                                </div>
                            </div>
                               <div class="form-group row">
                                ...
                                <div class="form-inline">
                                    <div class="col-sm-5">
                                        <asp:TextBox runat="server" CssClass="form-control money" Text="0" ID="nominal"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Jenis Bunga <span class="mandatory">*</span></label>
                                <div class="form-inline">
                                    <div class="col-sm-5">
                                        <asp:DropDownList ID="cbojnsbunga" runat="server" Width="150">
                            ...
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Bunga <span class="mandatory">*</span></label>
                                <div class="form-inline">
                                    <div class="col-sm-5">
                                        <asp:TextBox runat="server" CssClass="form-control money" Text="0" ID="bunga" Width="100"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                                     <div class="form-group row">
                                ...
                                <div class="form-inline">
                                    <div class="col-sm-9">
                                        <asp:DropDownList runat="server" AutoPostBack="false"  CssClass="form-control" ID="cboRek">                                           
                                      </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="deskripsi" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
            ...
            <div class="modal-body ">
                <div class="modal-body col-overflow-400">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="grdDataAsset" DataKeyNames="noRek" SkinID="GridView" AllowPaging="true" PageSize="10" runat="server" OnSelectedIndexChanged="grdDataAsset_SelectedIndexChanged" OnPageIndexChanging="grdDataAsset_PageIndexChanging">
                            <Columns>
