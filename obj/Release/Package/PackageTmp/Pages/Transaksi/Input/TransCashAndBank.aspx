<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransCashAndBank.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransCashAndBank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
                    ...
                    <div class="row">
                        <div class="form-horizontal">
                            <div class="col-sm-6">
                               ...
                               <div runat="server" id="formpembayaranhutang" visible="false">
                                    <div class="form-group">
                                        <div class="form-inline">
                                            <label class="col-sm-4 control-label">Cabang <span class="mandatory">*</span></label>
                                            <div class="col-sm-6">
                                                <asp:HiddenField runat="server" ID="hdnnopembayaranhutang" />
                                                <asp:TextBox runat="server" CssClass="form-control" Enabled="false" ID="txtpembayaranhutang"></asp:TextBox>
                                                <asp:ImageButton ID="btnpembayaranutang" CssClass="btn-image form-control" runat="server" ImageUrl="~/assets/images/icon_search.png" OnClick="btnpembayaranhutang_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <asp:GridView ID="grdBank" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdBank_PageIndexChanging" OnSelectedIndexChanged="grdBank_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Akun" ItemStyle-Width="25%">
                               ...
                               <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Deskripsi" ItemStyle-Width="25%">
                                <ItemTemplate>
                                    <div class="text-left">
    ...
    <asp:ModalPopupExtender ID="dlgpembayaran" runat="server" PopupControlID="panelPembayaran" TargetControlID="LinkButton12" BackgroundCssClass="modal-background">
    </asp:ModalPopupExtender>
    <asp:Panel ID="panelPembayaran" runat="server" align="center" Width="80%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Data Cabang</h4>
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            <asp:TextBox ID="txtsearchpembayaran" runat="server" CssClass="form-control" MaxLength="50" placeholder="Masukan kata"></asp:TextBox>
                            <asp:Button ID="btnsearchpembayaran" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnSearchPembayaran_Click" UseSubmitBehavior="false" OnClientClick="this.disabled = true; this.value = 'Proses...';" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-body col-overflow-500">
                <div class="table-responsive">
                    <asp:GridView ID="grdPembayaran" DataKeyNames="nocabang" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPembayaran_PageIndexChanging" OnSelectedIndexChanged="grdPembayaran_SelectedIndexChanged">
                       <Columns>
                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                <ItemTemplate>
                                    <div class="text-center">
            ...
            <div class="modal-footer">
                <asp:Button ID="Button12" runat="server" Text="Tutup" CssClass="btn btn-danger" CausesValidation="false" />
            </div>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="panelIuran" runat="server" align="center" Width="80%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body col-overflow-500">
                <div class="table-responsive">
                    <asp:GridView ID="grdIuran" DataKeyNames="nocabang" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdIuran_PageIndexChanging" OnSelectedIndexChanged="grdIuran_SelectedIndexChanged">
                       <Columns>
                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                <ItemTemplate>
                                    <div class="text-center">
