<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="UploadVASiswa.aspx.cs" Inherits="eFinance.Pages.Transaksi.Upload.UploadVASiswa" %>
                                ...
                                <div class="form-horizontal">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group" runat="server" id="showhidestatus">
                                            <label class="col-sm-3 control-label">Jenis VA <span class="mandatory">*</span></label>
                                            <div class="col-sm-3">
