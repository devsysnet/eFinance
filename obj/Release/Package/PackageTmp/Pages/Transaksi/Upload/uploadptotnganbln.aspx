<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="uploadptotnganbln.aspx.cs" Inherits="eFinance.Pages.Transaksi.Upload.uploadptotnganbln" %>
                                ...
                                <div class="form-horizontal">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                         ...
                                         <div class="form-group" runat="server" id="tgl">
                                            <label class="col-sm-3 control-label">Tanggal<span class="mandatory">*</span></label>
                                            <div class="col-sm-2">
                                                <asp:TextBox runat="server" CssClass="form-control date" ID="dtpotongan"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" runat="server" id="showhidetahun">
                                            ...
                                            <div class="col-sm-2">
                                                <asp:DropDownList ID="cbojenis" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboYear_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </div>
