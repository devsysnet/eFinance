<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="UploadRekening.aspx.cs" Inherits="eFinance.Pages.Transaksi.Upload.UploadRekening" %>
                                ...
                                <div class="form-horizontal">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="col-sm-3">
                                                <asp:DropDownList ID="cboAksi" Visible="false" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cboAksi_SelectedIndexChanged">
                                        ...
                                        <div class="form-group" runat="server" visible="false" id="showhidestatus">
                                        ...
                                        <div class="form-group" runat="server" id="divtombol">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <asp:Button runat="server" Visible="false" ID="btnExport" CssClass="btn btn-primary" Text="Download" OnClick="btnExport_Click"></asp:Button>
