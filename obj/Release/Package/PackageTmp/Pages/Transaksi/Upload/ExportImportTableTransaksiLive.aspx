<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="ExportImportTableTransaksiLive.aspx.cs" Inherits="eFinance.Pages.Transaksi.Upload.ExportImportTableTransaksiLive" %>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <asp:Button runat="server" ID="btnImport" CssClass="btn btn-success" Text="Import" Enabled="false" OnClick="btnImport_Click" Visible="false"></asp:Button>
