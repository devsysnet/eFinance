<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="mstKaryawanDetailUpload.aspx.cs" Inherits="eFinance.Pages.Master.Update.mstKaryawanDetailUpload" %>
                        ...
                        <div class="row" style="margin-left:-90px">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-horizontal">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Input Detail <span class="mandatory">*</span></label>
                                            <div class="col-sm-3">
                                                <asp:DropDownList ID="cboDetil" runat="server" CssClass="form-control" AutoPostBack="true">
                                                    <asp:ListItem Value="">---Pilih Detail---</asp:ListItem>
                                                    <asp:ListItem Value="identitas">Identitas</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="form-group">
