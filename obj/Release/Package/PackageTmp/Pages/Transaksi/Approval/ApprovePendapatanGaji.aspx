<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="ApprovePendapatanGaji.aspx.cs" Inherits="eFinance.Pages.Transaksi.Approval.ApprovePendapatanGaji" %>
                                ...
                                <asp:GridView ID="grdGajiKala" DataKeyNames="notransaksi" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Karyawan" ItemStyle-Width="30%">
                                         ...
                                         <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Keterangan" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="left">
                                                <ItemTemplate>
