<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Transapprovependapatanbln.aspx.cs" Inherits="eFinance.Pages.Transaksi.Approval.Transapprovependapatanbln" %>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive overflow-x-table">
                                <asp:GridView ID="grdGajiKala" DataKeyNames="notransaksi" SkinID="GridView" runat="server">
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <%# Container.DataItemIndex + 1 %>
                                                    <asp:HiddenField ID="hdnnotransgaji" runat="server" Value='<%# Bind("notransaksi") %>'  />
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Karyawan" ItemStyle-Width="30%">
                                         ...
                                         <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Pendapatan" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAlert" runat="server" Text='<%# Bind("komponengaji") %>' Width="150"></asp:Label>
                                                </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="false" HeaderStyle-CssClass="text-center" HeaderText="Pendapatan" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="right">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNilai" runat="server" Text='<%# Bind("nilai") %>' Width="100"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                      <%--  <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Level" ItemStyle-Width="15%">
                                        ...
                                        <asp:TemplateField Visible="false" HeaderStyle-CssClass="text-center" HeaderText="Approve" ItemStyle-Width="1%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                        ...
                                        <asp:TemplateField Visible="false" HeaderStyle-CssClass="text-center" HeaderText="Reject" ItemStyle-Width="1%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Pendapatan" ItemStyle-Width="1%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox ID="txtKeterangan" runat="server" Text='<%# Bind("nilai") %>' CssClass="form-control money" Width="200" />
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <div class="row" id="button" runat="server">
                        <div class="col-sm-12 ">
                            <div class="text-center">
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Approve" OnClick="btnSubmit_Click" />
