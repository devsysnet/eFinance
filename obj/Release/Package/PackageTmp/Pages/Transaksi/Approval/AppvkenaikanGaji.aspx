<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="AppvkenaikanGaji.aspx.cs" Inherits="eFinance.Pages.Transaksi.Approval.AppvkenaikanGaji" %>
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive overflow-x-table">
                                <asp:GridView ID="grdGajiRutin" DataKeyNames="noNaikgaji" SkinID="GridView" runat="server">
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <%# Container.DataItemIndex + 1 %>
                                                    <asp:HiddenField ID="hdnnoNaikgaji" runat="server" Value='<%# Bind("noNaikgaji") %>'  />
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Karyawan" ItemStyle-Width="30%">
                                         ...
                                         <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Golongan Lama" ItemStyle-Width="1%" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgollama" runat="server" Text='<%# Bind("gollama") %>' Width="80"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Golongan Baru" ItemStyle-Width="1%" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgolbaru" runat="server" Text='<%# Bind("golbaru") %>' Width="80"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Gaji Lama" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNilai" runat="server" Text='<%# Bind("gajilama","{0:#,0.00}") %>' Width="120"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Gaji Baru" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNila1i" runat="server" Text='<%# Bind("gajibaru","{0:#,0.00}") %>' Width="120"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Tanggal Mulai" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="dtMulaiSewa" runat="server" Text='<%# Bind("tglmulai","{0:dd MMM yyyy}") %>' Width="100"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Tgl Review" ItemStyle-Width="2%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox ID="dtReview" runat="server" CssClass="form-control date"/>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <div class="row" id="button" runat="server">
                        <div class="col-sm-12 ">
                            <div class="text-center">
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Save" OnClick="btnSubmit_Click" UseSubmitBehavior="false" OnClientClick="this.disabled = true; this.value = 'Proses...';"/>
