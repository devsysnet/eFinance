<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransCashAndBankUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransCashAndBankUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
        ...
        function Calculate() {
            ...
            if (transaksi == "1") {
                if (hasilDebit != 0)
                    ...
                    //document.getElementById("BodyContent_txtTotalDebit").value = money(round(nilai,2));
            ...
            if (transaksi == "2") {
                ...
                if (fromSup == "2" || fromSup == "3" || fromSup == "4" || fromSup == "5" || fromSup == "7")
                    //document.getElementById("BodyContent_txtTotalKredit").value = money(round(nilai, 2));
                    ...
                    <div id="tabGrid" runat="server">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-inline">
                                    <div class="col-sm-12">
                                        <asp:TextBox ID="Search" runat="server" CssClass="form-control" placeholder="Masukan Nomor Kode" Width="200">&nbsp;&nbsp;&nbsp;&nbsp;</asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-sm-12 overflow-x-table">
                                <asp:GridView ID="grdKas" DataKeyNames="noKas" SkinID="GridView" runat="server" AllowPaging="false" PageSize="10" OnPageIndexChanging="grdKas_PageIndexChanging"
                                    OnRowCommand="grdKas_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Tgl" HeaderStyle-CssClass="text-center" HeaderText="Tgl Kas / Bank" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd MMM yyyy}" />
                                        <asp:BoundField DataField="nomorKode" HeaderStyle-CssClass="text-center" HeaderText="Kode Kas / Bank" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="Cust" HeaderStyle-CssClass="text-center" HeaderText="Catatan Lain / Faktur / Kode Transaksi" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="status" HeaderStyle-CssClass="text-center" HeaderText="Status" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="nilaikas" HeaderStyle-CssClass="text-center" HeaderText="nilai" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="right" />
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-horizontal">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <asp:DropDownList runat="server" CssClass="form-control" ID="cboTransaction" Enabled="false">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div runat="server" id="formFromToCus">
                                                    <asp:DropDownList runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboFromToCus_SelectedIndexChanged" CssClass="form-control" ID="cboFromToCus" Enabled="false">
                                                ...
                                                <div runat="server" id="forFormToSupp" visible="false">
                                                    <asp:DropDownList runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboFromToSupp_SelectedIndexChanged" CssClass="form-control" ID="cboFromToSupp"  Enabled="false">
                                                        <%--<asp:ListItem Value="0">---Pilih Dari/Untuk---</asp:ListItem>
                                                        <asp:ListItem Value="1">Lain-lain</asp:ListItem>
                                        ...
                                        <div runat="server" id="formOther" visible="false">
                                            <div class="form-group">
                                                <div class="form-inline">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <asp:TextBox runat="server" CssClass="form-control" ID="txtOther" Width="200"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div runat="server" id="formPengembalian" visible="false">
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <asp:TextBox runat="server" CssClass="form-control" Enabled="false" ID="TextBox1"></asp:TextBox>
                                                <asp:ImageButton ID="ImageButton1" CssClass="btn-image form-control" runat="server" ImageUrl="~/assets/images/icon_search.png" OnClick="btnPengembalian_Click" />--%>
                                                    <asp:DropDownList runat="server" ID="DropDownList1" CssClass="form-control" Width="200"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div runat="server" id="formTampKeluar" visible="false">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList runat="server" ID="cboTampKeluar" CssClass="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div runat="server" id="formKegiatan" visible="false">
                                         ...
                                         <div runat="server" id="formpenerimaanunit" visible="false">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Unit <span class="mandatory">*</span></label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList runat="server" ID="cbounitpenerimaan" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                         <div runat="server" id="formKolekte" visible="false">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Jenis Kolekte <span class="mandatory">*</span></label>
                                        <div class="col-sm-7">
                                            <asp:DropDownList runat="server" ID="cbokolekte" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="formKolekte_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Mata Uang <span class="mandatory">*</span></label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList runat="server" CssClass="form-control" ID="cboCurrency" AutoPostBack="true" OnSelectedIndexChanged="cboCurrency_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form-group" runat="server" id="showhidekurs">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtKurs"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Nilai <span class="mandatory">*</span></label>
                                        <div class="col-sm-5">
                                            <asp:HiddenField ID="hdnValue" runat="server" />
                                            <asp:TextBox runat="server" CssClass="form-control money" Text="0.00" ID="txtValue" onKeyUp="Calculate()" onKeyDown="Calculate()"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div runat="server" id="formAngsuran" visible="false">
                                        <div class="form-group">
                                            <div class="form-inline">
                                                <label class="col-sm-5 control-label">Angsuran <span class="mandatory">*</span></label>
                                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Uraian <span class="mandatory">*</span></label>
                                        <div class="col-sm-7">
                                ...
                                <asp:GridView ID="grdKasBank" SkinID="GridView" runat="server" OnRowCommand="grdKasBank_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Akun" ItemStyle-Width="15%">
                                            <ItemTemplate>
                                                <div class="form-group">
                                                    <div class="form-inline">
                                                        <div class="text-center">
                                                            <asp:TextBox runat="server" ID="txtAccount" CssClass="form-control" OnTextChanged="txtAccount_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Debit" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox runat="server" CssClass="form-control money" Text="0.00" ID="txtDebit" OnTextChanged="txtDebit_TextChanged" onKeyUp="Calculate()" onKeyDown="Calculate()"></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Credit" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox runat="server" CssClass="form-control money" Text="0.00" ID="txtKredit" OnTextChanged="txtKredit_TextChanged" onKeyUp="Calculate()" onKeyDown="Calculate()"></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnSearchAkun" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnSearchAkun_Click" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdBank" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdBank_PageIndexChanging" OnSelectedIndexChanged="grdBank_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="text-left" HeaderText="Account Number" ItemStyle-Width="20%">
                                <ItemTemplate>
                                    <div class="text-left">
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="text-left" HeaderText="Nama Akun" ItemStyle-Width="20%">
                                <ItemTemplate>
                                    <div class="text-left">
                               ...
                               <asp:TemplateField HeaderStyle-CssClass="text-left" HeaderText="Deskripsi" ItemStyle-Width="20%">
                                <ItemTemplate>
                                    <div class="text-left">
                                        <asp:Label runat="server" ID="lbldesc" Text='<%#Eval("deskripsi")%>'></asp:Label>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnSearchPO" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnSearchPO_Click" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <asp:Panel ID="panelReimbersment" runat="server" align="center" Width="60%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnCariReimbersment" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnCariReimbersment_Click" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <asp:Button ID="Button3" runat="server" Text="Close" CssClass="btn btn-danger" CausesValidation="false" />
            </div>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="panelPR" runat="server" align="center" Width="60%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnSearchPR" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnSearchPR_Click" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdPR" DataKeyNames="noPR" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPR_PageIndexChanging" OnSelectedIndexChanged="grdPR_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundField DataField="kodePR" HeaderText="Kode PR" HeaderStyle-CssClass="text-center" ItemStyle-Width="12%" ItemStyle-HorizontalAlign="Center" />
                            ...
                            <asp:BoundField DataField="peminta" HeaderText="Peminta" HeaderStyle-CssClass="text-center" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}" />
            ...
            <div class="modal-footer">
                <asp:Button ID="Button4" runat="server" Text="Close" CssClass="btn btn-danger" CausesValidation="false" />
            </div>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="panelGaji" runat="server" align="center" Width="80%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnSearchGaji" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnSearchGaji_Click" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <asp:Button ID="Button5" runat="server" Text="Close" CssClass="btn btn-danger" CausesValidation="false" />
            </div>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="panelIuran" runat="server" align="center" Width="80%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnSearchIuran" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnSearchIuran_Click" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <asp:Button ID="Button6" runat="server" Text="Close" CssClass="btn btn-danger" CausesValidation="false" />
            </div>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="panelKasBon" runat="server" align="center" Width="60%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnSearchKasBon" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnSearchKasBon_Click" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <asp:Button ID="Button7" runat="server" Text="Close" CssClass="btn btn-danger" CausesValidation="false" />
            </div>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="panelTHR" runat="server" align="center" Width="80%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
                ...
                <div class="col-sm-5">
                    <div class="form-inline">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnSearchTHR" runat="server" CssClass="btn btn-primary btn-sm" Text="Cari" OnClick="btnSearchTHR_Click" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <asp:Button ID="Button8" runat="server" Text="Close" CssClass="btn btn-danger" CausesValidation="false" />
            </div>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="panelPengembalian" runat="server" align="center" Width="50%" Style="display: none" CssClass="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body col-overflow-500">
                <div class="table-responsive">
                    <asp:GridView ID="grdPengembalian" DataKeyNames="norekkredit" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPengembalian_PageIndexChanging" OnSelectedIndexChanged="grdPengembalian_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                <ItemTemplate>
                                    <div class="text-center">
