<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransQuotationUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransQuotationUpdate" %>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-12 overflow-x-table">
                                <asp:GridView ID="grdSOD" SkinID="GridView" runat="server" OnRowDataBound="grdPO_RowDataBound" OnRowCommand="grdPO_RowCommand">
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Unit" ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <div class="text-center">
                                                  <asp:TextBox runat="server" CssClass="form-control" ID="lblUnit" Enabled="true"  Width="170"></asp:TextBox>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
