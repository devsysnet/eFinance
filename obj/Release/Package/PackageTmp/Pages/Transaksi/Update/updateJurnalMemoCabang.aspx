<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="updateJurnalMemoCabang.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.updateJurnalMemoCabang" %>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdMemoJurnal" SkinID="GridView" runat="server" AllowPaging="false"  OnRowCommand="grdMemoJurnal_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Unit" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-center">
