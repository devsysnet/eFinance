<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransAssetUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransAssetUpdate" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdAssetUpdate" DataKeyNames="noAset" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdAssetUpdate_PageIndexChanging" OnRowCommand="grdAssetUpdate_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="kodeAsset" HeaderText="Kode Aset" HeaderStyle-CssClass="text-center" ItemStyle-Width="10%" />
                                            ...
                                            <asp:BoundField DataField="atasnama" HeaderText="Atas Nama" HeaderStyle-CssClass="text-center" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox ID="txtKode" runat="server" Enabled="false" CssClass="form-control" Width="150"></asp:TextBox>
                                    </div>
                                </div>
                                  <div class="form-group row">
                            ...
                            <div runat="server" id="divassettidakbergerak">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtkecamatan" Width="200"></asp:TextBox>
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Kabupaten/Kota<span class="mandatory">*</span></label>
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtkota" Width="200"></asp:TextBox>
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtperuntukan"  ></asp:TextBox>
                                </div>
                            </div>
