<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransRealisasiKasbonUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransRealisasiKasbonUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <script type="text/javascript">
        ...
        function CheckAllData(Checkbox) {
            var GridVwHeaderChckbox = document.getElementById("<%=grdKasUpdate.ClientID %>");
                                ...
                                <asp:GridView ID="grdKasUpdate" DataKeyNames="nokasbondana" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdKasUpdate_PageIndexChanging" OnSelectedIndexChanged="grdKasUpdate_SelectedIndexChanged">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="3%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:Button ID="btnDetail" runat="server" class="btn btn-primary btn-sm" Text="Update" CommandName="Select" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>' CausesValidation="false" />
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdMemoJurnal" SkinID="GridView" runat="server" AllowPaging="true" OnSelectedIndexChanged="grdMemoJurnal_SelectedIndexChanged">
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
