<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransKompetensiUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransKompetensiUpdate" %>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-inline">
                                            ...
                                            <div class="col-sm-6">
                                                  <asp:TextBox ID="txtSkor" Width="100" runat="server" CssClass="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
