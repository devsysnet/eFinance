<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPindahAssetUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransPindahAssetUpdate" %>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-inline">
                                        <div class="col-sm-9">
                                            ...
                                            <asp:ImageButton ID="btnBrowseAsset" runat="server" ImageUrl="~/assets/images/icon_search.png" Enabled="True" CssClass="btn-image form-control" OnClick="btnBrowseAsset_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
