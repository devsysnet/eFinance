<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="PostingharianKas1.aspx.cs" Inherits="eFinance.Pages.Transaksi.Posting.PostingharianKas1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <script>
        function confirm() {
            bootbox.confirm({
                message: "Are you sure to posting data?",
                callback: function (result) {
                    if (result == true) {
                        document.getElementById('<%=hdnMode.ClientID%>').value = "confirm";
                        eval("<%=execBind%>");
                    }
                },
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <asp:Button runat="server" ID="btnPosting" CssClass="btn btn-primary" Text="Posting" OnClientClick=" confirm();" UseSubmitBehavior="false" ></asp:Button>
