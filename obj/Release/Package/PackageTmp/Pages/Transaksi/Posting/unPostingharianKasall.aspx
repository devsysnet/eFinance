<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="unPostingharianKasall.aspx.cs" Inherits="eFinance.Pages.Transaksi.Posting.unPostingharianKasall" %>
            ...
            <div class="panel">
                <div class="panel-body">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <asp:DropDownList runat="server" CssClass="form-control" ID="cboAccount" AutoPostBack="true" Width="500"></asp:DropDownList>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <asp:Button runat="server" ID="btnPosting" CssClass="btn btn-primary" Text="uNPosting" OnClick="btnPosting_Click" UseSubmitBehavior="false" OnClientClick="this.disabled = true; this.value = 'Proses...';"></asp:Button>
                            </div>
                        </div>
                    </div>
                </div>
