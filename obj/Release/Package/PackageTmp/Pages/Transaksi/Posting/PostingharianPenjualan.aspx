<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="PostingharianPenjualan.aspx.cs" Inherits="eFinance.Pages.Transaksi.Posting.PostingharianPenjualan" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <asp:GridView ID="grdHarianGL" DataKeyNames="kdpenjualan" SkinID="GridView" runat="server" AllowPaging="false" PageSize="10" OnPageIndexChanging="grdHarianGL_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="kdpenjualan" SortExpression="nomorKode" HeaderText="Nomor Transaksi" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="tgljual" SortExpression="tgl" HeaderText="Tgl Transaksi" ItemStyle-Width="10%" DataFormatString="{0:dd MMM yyyy}" ItemStyle-HorizontalAlign="Left" />
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="1%" HeaderText="Debet">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label ID="lblDebet" runat="server" Text='<%# Bind("total", "{0:#,0.00}") %>' Width="180"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
