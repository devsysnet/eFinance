<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstApprovalNilaiView.aspx.cs" Inherits="eFinance.Pages.Master.View.MstApprovalNilaiView" %>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jabatan" ItemStyle-Width="15%">
                                                        <ItemTemplate>
                                                            <div class="text-center">
                                                                <div class="form-inline">
                                                                    <asp:DropDownList ID="cboJabatan" runat="server" Enabled="false"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
