<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstAssetiew.aspx.cs" Inherits="eFinance.Pages.Master.View.MstAssetiew" %>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="form-inline">
                                    <div class="col-sm-5">
                                        <asp:DropDownList ID="cboBangunan" runat="server" Enabled="false" Width="150">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <asp:TextBox runat="server" class="form-control" ID="txtKelompok" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Masa :</label>
                                <div class="col-sm-3">
                                    <asp:TextBox runat="server" class="form-control" ID="txtMasa" Enabled="false" Width="35"></asp:TextBox>&nbsp;&nbsp; Tahun
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-inline">
                                    <div class="col-sm-5">
                                        <asp:DropDownList ID="cboJenis" runat="server" Enabled="false"  Width="150">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <asp:TextBox runat="server" class="form-control" ID="txtTarif" Enabled="false" Width="35" Align="left"></asp:TextBox>&nbsp;&nbsp;&nbsp;%
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
