...
{
    public partial class MstRekeningTransaksiKasView : System.Web.UI.Page
    {
        ...
        protected void grdAsset_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                hdnId.Value = noKurs;
                DataSet MySet = ObjDb.GetRows("select * from mRekeningtranskasikas a inner join mJenisTransaksiKas b on a.noTransKas=b.noTransKas inner join mRekening c on a.norek = c.noRek where a.notrsrek = '" + noKurs + "'");
                if (MySet.Tables[0].Rows.Count > 0)
                {
