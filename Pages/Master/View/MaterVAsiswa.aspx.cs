...
namespace eFinance.Pages.Transaksi.View
{
    public partial class MaterVAsiswa : System.Web.UI.Page
    {
        ...
        protected void loadDataKelas(string cboCabang = "")
        {
            ...
            {
                cboKelas.DataSource = ObjDb.GetRows("select * from (select '' as id, '-Pilih Kelas-' as name union all select distinct kelas as id, kelas as name from TransKelas where nocabang = '" + cboCabang + "' and tahunAjaran = '"+tahunAjaran+"')x");
                cboKelas.DataValueField = "id";
                cboKelas.DataTextField = "name";
                cboKelas.DataBind();
            }
