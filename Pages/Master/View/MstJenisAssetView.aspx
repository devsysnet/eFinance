<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisAssetView.aspx.cs" Inherits="eFinance.Pages.Master.View.MstJenisAssetView" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdGudang" DataKeyNames="Jenis" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdGudang_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Jenis" SortExpression="kdGudang" HeaderText="Jenis Asset" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" />
                                        ...
                                        <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Asset" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtJnsAsset" Enabled="false" runat="server" CssClass="form-control" Text='<%# Bind("Jenis") %>'></asp:TextBox>
                                                            <asp:HiddenField ID="hdnJnsAsset" runat="server" Value='<%# Bind("Jenis") %>' />
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
