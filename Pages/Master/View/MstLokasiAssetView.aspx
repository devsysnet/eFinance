<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstLokasiAssetView.aspx.cs" Inherits="eFinance.Pages.Master.View.MstLokasiAssetView" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdAsset" SkinID="GridView" DataKeyNames="noSubLokasi" runat="server" AllowPaging="true" PageSize="10"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Lokasi" SortExpression="kodeMataUang" HeaderText="Lokasi" ItemStyle-Width="15%" />
                                            <asp:BoundField DataField="SubLokasi" SortExpression="tglKursBuku" HeaderText="Sub Lokasi" ItemStyle-Width="15%" />
                                ...
                                <div class="panel">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="pjs-ex1-fullname" class="col-sm-3 control-label">Lokasi</label>
                                                    <div class="col-sm-5">
                                                    ...
                                                    <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Sub Lokasi" ItemStyle-Width="5%">
                                                                <ItemTemplate>
                                                                    <div class="text-center">
                                                                        <asp:TextBox ID="txtInstansi" runat="server" CssClass="form-control" placeholder="Code" Enabled="False"></asp:TextBox>
        ...
        <div class="modal-content size-sedang">
            ...
            <div class="modal-footer">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <asp:TextBox runat="server" class="form-control" ID="txtBrand" type="text" Enabled="false"></asp:TextBox>
