<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MasterDataKaryawan.aspx.cs" Inherits="eFinance.Pages.Master.View.MasterDataKaryawan" %>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                 ...
                                                 <div class="col-sm-2">
                                                    <asp:DropDownList ID="cboAktif" runat="server" CssClass="form-control" Width="150" AutoPostBack="true" OnSelectedIndexChanged="cboAktif_SelectedIndexChanged">
                                                   
                                                </asp:DropDownList>
                                                </div>
                                                <div class="col-sm-2">
                                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Masukan kata" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" Width="200"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            ...
                                            <asp:GridView ID="grdCustomer" DataKeyNames="noKaryawan" SkinID="GridView" runat="server" AllowPaging="true" PageSize="100" OnPageIndexChanging="grdCustomer_PageIndexChanging"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="nama" HeaderText="Nama" ItemStyle-Width="23%" HeaderStyle-CssClass="text-center" />
                        ...
                        <div class="panel">
                            <div class="panel-body" id="Tabs" role="tabpanel">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li>
                                        <a href="#tab-mutasi" data-toggle="tab" role="tab">History</a>
                                    </li>
                                     <li>
                                        <a href="#tab-kpi" data-toggle="tab" role="tab">Nilai KPI</a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content tab-content-bordered">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-mutasi">
                                        <div class="row">
                                            <fieldset class="fsStyle">
                                                <legend class="legendStyle"><b>History Karyawan</b></legend>
                                                <asp:GridView ID="GridMutasi" SkinID="GridView" runat="server">
                                                    <Columns>
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                        ...
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="20%" HeaderText="Kode Mutasi">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:TextBox ID="kdMutasi" runat="server" Enabled="false" CssClass="form-control"></asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="16%" HeaderText="Tanggal">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:TextBox runat="server" CssClass="form-control  " Enabled="false" ID="tglMutasi"></asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="16%" HeaderText="Kategori">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:TextBox runat="server" CssClass="form-control  " Enabled="false" ID="kategoriMutasi"></asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="20%" HeaderText="Keterangan">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:TextBox runat="server" CssClass="form-control  " Enabled="false" ID="ketMutasi"></asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="20%" HeaderText="Ke Cabang">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:TextBox runat="server" CssClass="form-control  " Enabled="false" ID="keCabang"></asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-kpi">
                                        <div class="row">
                                            <fieldset class="fsStyle">
                                                <legend class="legendStyle"><b>Nilai KPI</b></legend>
                                                <asp:GridView ID="grdkpi" SkinID="GridView" runat="server">
                                                    <Columns>
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                        ...
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="8%" HeaderText="Kode Soal">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:Label ID="kdKPI" runat="server"  ></asp:Label>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="16%" HeaderText="Tanggal">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:Label runat="server"  ID="tglKPI"></asp:Label>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                          <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="15%" HeaderText="Tipe">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:Label runat="server"  ID="tipekpi"></asp:Label>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="30%" HeaderText="Uraian">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:Label runat="server"   ID="uKPI"></asp:Label>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="8%" HeaderText="Nilai">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                                    <asp:Label runat="server"  ID="nKPI"></asp:Label>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
