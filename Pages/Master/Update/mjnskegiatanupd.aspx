<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="mjnskegiatanupd.aspx.cs" Inherits="eFinance.Pages.Master.Update.mjnskegiatanupd" %>
                                        ...
                                        <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Kegiatan" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtnamakegiatan" runat="server" CssClass="form-control" Text='<%# Bind("namakegiatan") %>'></asp:TextBox>
