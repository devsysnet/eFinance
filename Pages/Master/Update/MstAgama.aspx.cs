    ...
    public partial class MstAgama : System.Web.UI.Page
    {
        ...
        protected void grdGudang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                grdInstansi.DataSource = ObjDb.GetRows("select * from mAgama WHERE Agama ='" + hdnId.Value + "'");
                grdInstansi.DataBind();
            ...
            try
            {
                if (hdnMode.Value.ToLower() == "deleteall")
                {
                    ...
                    if (arrayItem != null)
                    {
                        ...
                        {
                            ObjDb.Where.Clear();
                            ObjDb.Where.Add("Agama", itemRow);
                            ObjDb.Delete("mAgama", ObjDb.Where);
                        }
                    }
