<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstPotongangajiupdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstPotongangajiupdate" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-inline">
                                    <div class="col-sm-12">
                                        <label>Search : </label>
                                        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" MaxLength="50" PlaceHolder="PTKP Name"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdPTKP" DataKeyNames="nopotonganterlambat" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPTKP_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="dari" SortExpression="dari" HeaderText="Dari" ItemStyle-Width="15%" />
                                            <asp:BoundField DataField="ke" SortExpression="Nominal" HeaderText="Ke" ItemStyle-Width="15%" />
                                            <asp:BoundField DataField="jenis" SortExpression="Nominal" HeaderText="Jenis" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="nilai" SortExpression="Nominal" HeaderText="Nilai" ItemStyle-Width="10%" />
                                            ...
                                            <asp:TemplateField HeaderText="EDIT" HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <a href="javascript:void()" class="btn btn-xs btn-labeled btn-primary" onclick="return EditRow('<%#Eval("nopotonganterlambat")%>')">Edit</a>
                                                        <%--<a href="javascript:void()" class="btn btn-xs btn-labeled btn-danger" onclick="return DeleteRow('<%#Eval("nopotonganterlambat")%>', '<%#Eval("PTKP")%>')">Delete</a>--%>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Dari <span class="mandatory">*</span></label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtdari" runat="server" CssClass="form-control" MaxLength="50" placeholder="PTKP"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Ke</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtke" runat="server" CssClass="form-control money"  MaxLength="50" placeholder="Nominal"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtnilai" runat="server" CssClass="form-control money"  MaxLength="50" placeholder="Nominal"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
