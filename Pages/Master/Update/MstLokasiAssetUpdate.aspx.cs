...
{
    public partial class MstLokasiAssetUpdate : System.Web.UI.Page
    {
        ...
        private void SetInitialRow(string nosub = "")
        {
            ...
            DataSet mySet = ObjDb.GetRows("select * from mSubLokasi WHERE noSubLokasi = '" + nosub + "' and nosublokasi not in(select nosublokasi from tasset) ");
        ...
        {
            grdAsset.DataSource = ObjDb.GetRows("select * from mSubLokasi a inner join mLokasi b on a.nolokasi=b.nolokasi where  (a.SubLokasi LIKE '%" + txtSearch.Text + "%' and b.nocabang='" + ObjSys.GetCabangId + "') or (b.Lokasi LIKE '%" + txtSearch.Text + "%' and b.nocabang='" + ObjSys.GetCabangId + "') and a.nosublokasi not in(select nosublokasi from tasset) ");
            grdAsset.DataBind();
        }
