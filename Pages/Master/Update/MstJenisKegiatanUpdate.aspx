<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisKegiatanUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstJenisKegiatanUpdate" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdAsset" SkinID="GridView" DataKeyNames="noMkegiatan" runat="server" AllowPaging="true" PageSize="10"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="namaKegiatan" SortExpression="kodeMataUang" HeaderText="Jenis Kegiatan" ItemStyle-Width="15%" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                                                <ItemTemplate>
                                                                    <div class="text-center">
                                                                        <%# Container.DataItemIndex + 1 %>
                                                                        <asp:TextBox ID="hdnNoMKegiatanD" runat="server" style="display:none"></asp:TextBox>
                                                                    </div>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
