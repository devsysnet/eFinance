<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstApprovalHargaUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstApprovalHargaUpdate" %>
                                            ...
                                            <asp:GridView ID="grdApproval" SkinID="GridView" Width="60%" runat="server" HorizontalAlign="Center">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Dari Nilai" ItemStyle-Width="15%">
                                                        <ItemTemplate>
                                                            <div class="text-center">
                                                                <asp:TextBox runat="server" ID="txtdrNilai" CssClass="form-control money"></asp:TextBox>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Sampai Nilai" ItemStyle-Width="15%">
                                                        <ItemTemplate>
                                                            <div class="text-center">
                                                                <asp:TextBox runat="server" ID="txtkeNilai" CssClass="form-control money"></asp:TextBox>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
