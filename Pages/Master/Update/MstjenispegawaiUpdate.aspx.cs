...
{
    public partial class mstStatusjenisPegUpdate : System.Web.UI.Page
    {
        ...
        protected void grdGudang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                grdInstansi.DataSource = ObjDb.GetRows("select * from Mstjenispegawai WHERE statuspegawai ='" + hdnId.Value + "'");
                grdInstansi.DataBind();
                ...
                if (hdnMode.Value.ToLower() == "deleteall")
                {
                    ...
                    if (arrayItem != null)
                    {
                        foreach (string itemRow in arrayItem)
                        {
                            ...
                            ObjDb.Delete("Mstjenispegawai", ObjDb.Where);
                        }
                    }
                ...
                try
                {
                    for (int i = 0; i < grdInstansi.Rows.Count; i++)
                    {
                        ...
                        if (txtAgama.Text != "")
                        {
                            ...
                            ObjDb.Update("Mstjenispegawai", ObjDb.Data, ObjDb.Where);
