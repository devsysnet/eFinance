<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="mstKolekteUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.mstKolekteUpdate" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="JenisKolekte" HeaderStyle-CssClass="text-center" HeaderText="Jenis Kolekte" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="left" />
                                             <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <asp:Button ID="btnDetail" runat="server" class="btn btn-primary btn-sm" Text="Ubah" CommandName="Select" />
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <asp:TextBox runat="server" CssClass="form-control" Enabled="true" ID="txtKode"></asp:TextBox>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdMemoJurnal" SkinID="GridView" runat="server" AllowPaging="false"  OnRowCommand="grdMemoJurnal_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Akun" ItemStyle-Width="35%">
                                            <ItemTemplate>
                                                <div class="text-center">
