<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstAgama.aspx.cs" Inherits="eFinance.Pages.Master.Update.MstAgama" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdGudang" DataKeyNames="Agama" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdGudang_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Agama" SortExpression="kdGudang" HeaderText="Agama" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" />
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Agama" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtAgama" runat="server" CssClass="form-control" Text='<%# Bind("Agama") %>'></asp:TextBox>
