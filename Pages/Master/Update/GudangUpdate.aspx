<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="GudangUpdate.aspx.cs" Inherits="eFinance.Pages.Master.Update.GudangUpdate" %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <asp:DropDownList runat="server" ID="cboJenisGudang">
                                            <asp:ListItem Value="Bagus">Bagus</asp:ListItem>
