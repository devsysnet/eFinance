    ...
    public partial class mKota : System.Web.UI.Page
    {
        ...
        protected void grdGudang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                grdInstansi.DataSource = ObjDb.GetRows("select * from mKota WHERE Kota ='" + hdnId.Value + "'");
                grdInstansi.DataBind();
            ...
            try
            {
                if (hdnMode.Value.ToLower() == "deleteall")
                {
                    ...
                    if (arrayItem != null)
                    {
                        ...
                        {
                            ObjDb.Where.Clear();
                            ObjDb.Where.Add("Kota", itemRow);
                            ObjDb.Delete("mKota", ObjDb.Where);
                        }
                    }
