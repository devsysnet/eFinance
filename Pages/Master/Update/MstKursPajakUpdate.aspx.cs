...
{
    public partial class MstKursPajakUpdate : System.Web.UI.Page
    {
                    ...
                    for (int i = 0; i < grdInstansi.Rows.Count; i++)
                    {
                        ...
                        else
                        {
                            if (txtInstansi.Text != "")
                            {
                                ObjDb.Data.Clear();
                                ObjDb.Where.Clear();
                                ObjDb.Where.Add("noKursPajak", hdnId.Value);
                                ObjDb.Data.Add("noMataUang", hdnCurrency.Value);
                                ObjDb.Data.Add("tglKursPajak", dtTgl1.Text);
                                ObjDb.Data.Add("nilaiKursPajak", txtInstansi.Text);
                                ...
                                ObjDb.Update("tKursPajak", ObjDb.Data, ObjDb.Where);
