<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstOrganisasi.aspx.cs" Inherits="eFinance.Pages.Master.Input.MstOrganisasi" %>
                    ...
                    <div class="col-sm-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Atasan :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList ID="cboCurrencyTrans" OnSelectedIndexChanged="cboCabang_SelectedIndexChanged" class="form-control" runat="server" Width="330"></asp:DropDownList>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="table-responsive">
                            <asp:GridView ID="grdMemoJurnal" Width="600px" SkinID="GridView" runat="server" AllowPaging="false" OnSelectedIndexChanged="grdMemoJurnal_SelectedIndexChanged" OnRowCommand="grdMemoJurnal_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Kode Karyawan" ItemStyle-Width="50%">
                                        <ItemTemplate>
                                            <div class="form-group">
                                                   <div class="form-inline">
                                                        <div class="text-center">
                                                   
                                                        <asp:TextBox runat="server" CssClass="form-control" ID="txtAccount" AutoPostBack="true"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Bawahan" ItemStyle-Width="50%">
                                        <ItemTemplate>
                                            <div class="text-center">
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" Visible="false" HeaderText="Keterangan" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <div class="text-center">
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" Visible="false" HeaderText="Debit" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <div class="text-center">
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" Visible="false" HeaderText="Kredit" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <div class="text-center">
                    ...
                    <asp:GridView ID="grdProduct" runat="server" SkinID="GridView" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdProduct_PageIndexChanging" OnSelectedIndexChanged="grdProduct_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Akun" HeaderStyle-Width="10%" HeaderStyle-CssClass="text-center">
                                <ItemTemplate>
                                    <asp:Label ID="lblKodeReagent" runat="server" Text='<%# Bind("idpeg") %>'></asp:Label>
                                    <asp:HiddenField ID="hidNoReagent" runat="server" Value='<%# Eval("nokaryawan") %>'></asp:HiddenField>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Nama Akun" HeaderStyle-Width="30%" HeaderStyle-CssClass="text-center">
                                <ItemTemplate>
                                    <asp:Label ID="lblNamaReagent" runat="server" Text='<%# Bind("nama") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
