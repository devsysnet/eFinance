<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstJenisTugas.aspx.cs" Inherits="eFinance.Pages.Master.Input.MstJenisTugas" %>
                                ...
                                <asp:GridView ID="grdInstansi" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Tugas" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox ID="jnsTugas" runat="server" CssClass="form-control"  placeholder="Jenis Tugas"></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
