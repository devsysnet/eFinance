...
{
    public partial class GudangInsert : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ObjSys.SessionCheck("GudangInsert.aspx");
            }
        }
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (valid == true)
            {
                try
                {
                    ...
                    {
                        string Kode = ObjSys.GetCodeAutoNumber("30", Convert.ToDateTime(ObjSys.GetNow).ToString("yyyy-MM-dd"));
                        ObjDb.Data.Add("kdGudang", Kode);
