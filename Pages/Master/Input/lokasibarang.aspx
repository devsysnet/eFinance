<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="lokasibarang.aspx.cs" Inherits="eFinance.Pages.Master.Input.lokasibarang" %>
                        ...
                        <asp:GridView ID="grdProdLoc" SkinID="GridView" runat="server">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Lokasi Gudang" ItemStyle-Width="50%">
                                 ...
                                 <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Minimum Stock" ItemStyle-Width="50%">
                                    <ItemTemplate>
                                        <div class="text-center">
                                           <asp:TextBox runat="server" CssClass="form-control" ID="txtMinStok"></asp:TextBox>
                                        </div>
