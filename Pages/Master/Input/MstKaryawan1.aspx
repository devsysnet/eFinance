<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MstKaryawan1.aspx.cs" Inherits="eFinance.Pages.Master.Input.MstKaryawan1" %>
                    ...
                    <div class="panel">
                        <div class="panel-body" id="Tabs" role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <a href="#tab-Keluarga" data-toggle="tab" role="tab">Keluarga</a>
                                </li>
                                <li>
                                ...
                                <%-- <li>
                                    <a href="#tab-Riwayatsakit" data-toggle="tab" role="tab">Riwayat Sakit</a>
                                </li>--%>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content tab-content-bordered">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-horizontal">
                                                    <div class="form-group" style="display:none">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">NUPTK </label>
                                                        <div class="col-sm-7">
                                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtNUPTK" placeholder="NUPTK" Width="180"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Nama Karyawan<span class="mandatory">*</label>
                                                        <div class="col-sm-7">
                                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtNama" placeholder="Nama"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Tempat Lahir</label>
                                                        <div class="col-sm-7">
                                                            <asp:TextBox runat="server" CssClass="form-control" ID="txttempatlahir" placeholder="Tempat Lahir" Width="250"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Tanggal Lahir</label>
                                                        <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList ID="cboAgama" CssClass="form-control" runat="server" Width="150"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">KewargaNegaraan</label>
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList ID="cboKewarganegaraan" runat="server" CssClass="form-control" Width="90">
                                                                <asp:ListItem Value="-">----</asp:ListItem>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList ID="cboGolongandarah" runat="server" CssClass="form-control" Width="90">
                                                                <asp:ListItem Value="-">----</asp:ListItem>
                                                    ...
                                                    <div class="form-group" style="display:none">
                                                        <div class="form-inline">
                                                            <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Tinggi Badan</label>
                                                            <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group" style="display:none">
                                                        <div class="form-inline">
                                                            <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Berat Badan</label>
                                                            <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Status Tanggungan</label>
                                                        <div class="col-sm-3">
                                                            <asp:DropDownList ID="cbostatusPTK" CssClass="form-control" runat="server" Width="100"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Status Perkawinan</label>
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="cboPerkawinan" runat="server" CssClass="form-control" Width="150">
                                                                <asp:ListItem Value="-">---</asp:ListItem>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <asp:DropDownList ID="cboJabatan" CssClass="form-control" runat="server" Width="200"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Akta 4</label>
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList ID="cboAkta" runat="server" CssClass="form-control" Width="80">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <asp:TextBox runat="server" CssClass="form-control date" ID="dtcapegTMT"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                     <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <asp:DropDownList ID="cboGolPegawai" CssClass="form-control" runat="server" Width="150"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Jabatan Struktural/Tugas Tambahan</label>
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="cboDepartemen" CssClass="form-control" runat="server" Width="270"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Telephone</label>
                                                        <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="cboStsPegawai" CssClass="form-control" runat="server" Width="200"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group" style="display:none">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Jenis Pegawai</label>
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="cbostatuspegawai" CssClass="form-control" runat="server" Width="250"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">PPH 21</label>
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList ID="ph21" runat="server" CssClass="form-control" Width="50">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <asp:DropDownList ID="cboCabang" runat="server" CssClass="form-control"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="grdPendidikan" SkinID="GridView" runat="server">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="5%" HeaderText="Dari Tahun">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                        ...
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="5%" HeaderText="Sampai Tahun">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                                        ...
                                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="7%" HeaderText="Nilai">
                                                            <ItemTemplate>
                                                                <div class="text-center">
                                ...
                                <div role="tabpanel" class="tab-pane" id="tab-Keluarga">
                                    <div class="row">
                                        <fieldset class="fsStyle">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="table-responsive">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <div class="text-center">
                                                                <asp:Button ID="btnIuran" runat="server" CssClass="btn btn-default" Text="Add Row" OnClick="btnAddIuran_Click" />
