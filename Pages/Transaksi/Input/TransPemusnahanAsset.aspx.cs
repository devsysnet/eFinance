...
{
    public partial class TransPemusnahanAsset : System.Web.UI.Page
    {
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (valid == true)
            {
                try
                {
                    ...
                    string Kode = ObjSys.GetCodeAutoNumberNew("105", Convert.ToDateTime(ObjSys.GetNow).ToString("yyyy-MM-dd"));
                    ObjGlobal.Param.Clear();
                    ObjGlobal.Param.Add("kdkrgAsset", Kode);
                    ...
                    ObjGlobal.Param.Add("nilaibuku", "0");
                    ObjGlobal.Param.Add("keterangan", txtUraian.Text);
                    ObjGlobal.Param.Add("createdBy", ObjSys.GetUserId);
                    ObjGlobal.GetDataProcedure("SPInsertTransPemusnahanAsset", ObjGlobal.Param);
                    ObjSys.UpdateAutoNumberCodeNew("105", Convert.ToDateTime(ObjSys.GetNow).ToString("yyyy-MM-dd"));
