...
{
    public partial class TransTerimaBarang : System.Web.UI.Page
    {
        ...
        protected void loadData()
        {
            ...
            grdKas.DataSource = ObjGlobal.GetDataProcedure("SPTerimaBarang", ObjGlobal.Param);
            grdKas.DataBind();
        }
                ...
                if (valid == true)
                {
                    ...
                    if (mySetH.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < grdReceive.Rows.Count; i++)
                        {
                            ...
                            ObjGlobal.GetDataProcedure("SPUpdateTerimaBrgDD", ObjGlobal.Param);
