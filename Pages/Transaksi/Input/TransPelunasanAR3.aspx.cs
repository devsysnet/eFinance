...
{
    public partial class TransPelunasanAR3 : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < grdARSiswa.Rows.Count; i++)
                {
                    ...
                    {
                        string Kode1 = ObjSys.GetCodeAutoNumberNew("1", Convert.ToDateTime(dtBayar.Text).ToString("yyyy-MM-dd"));
                        cek += hdnNoPiut.Value + ",";
                        ...
                        ObjGlobal.Param.Add("kode", Kode1);
                        ...
                        ObjGlobal.GetDataProcedure("SPInputTransPembayaran", ObjGlobal.Param);
                        ...
                        ObjSys.UpdateAutoNumberCodeNew("1", Convert.ToDateTime(dtBayar.Text).ToString("yyyy-MM-dd"));
                    }
                }

                string Kode = ObjSys.GetCodeAutoNumberNew("1", Convert.ToDateTime(dtBayar.Text).ToString("yyyy-MM-dd"));
                DataSet cabangBisaCetak1 = ObjDb.GetRows("select * from mCabang where cetakvoucher = 1 and noCabang = " + cboPerwakilanUnit.Text + "");
                if (cabangBisaCetak1.Tables[0].Rows.Count > 0)
                {
                    ...
                    Param.Clear();
                    Param.Add("nomorKode", Kode);
                    HttpContext.Current.Session.Add("ParamReport", Param);
                    Session["REPORTNAME"] = "PrintKuwitansi3.rpt";
                ...
                ObjGlobal.Param.Add("Uraian", "Tampungan Pembayaran Siswa " + hdnjnsTrans.Value + "");
                ...
                ObjGlobal.Param.Add("jenisTran", "Tampungan Pembayaran Siswa");
                ...
                ObjGlobal.Param.Add("kredit", Convert.ToDecimal(totalbayar).ToString());
                ObjGlobal.Param.Add("sts", "0");
                ObjGlobal.Param.Add("Tgl", Convert.ToDateTime(dtBayar.Text).ToString("yyyy-MM-dd"));
                ObjGlobal.Param.Add("noCabang", ObjSys.GetCabangId);
                ObjGlobal.Param.Add("createdBy", ObjSys.GetUserId);
                ObjGlobal.Param.Add("createdDate", ObjSys.GetNow);
                ObjGlobal.GetDataProcedure("SPInputKasDetilPelunasantampungan", ObjGlobal.Param);
