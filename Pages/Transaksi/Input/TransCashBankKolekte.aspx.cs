...
{
    public partial class TransCashBankKolekte : System.Web.UI.Page
    {
        ...
        {
            cboFromToCus.DataSource = ObjDb.GetRows("select a.* from (select '0' id,'---Pilih Dari/Untuk---' name union all SELECT distinct noTransKas id, JnsTransKas name FROM mJenisTransaksiKas where noJnsTransKas = '3' and kategoriUsaha is null union all SELECT distinct noTransKas id, JnsTransKas name FROM mJenisTransaksiKas where noJnsTransKas = '3' and kategoriUsaha = '" + ObjSys.GetKategori_Usaha + "') a order by a.id");
            cboFromToCus.DataValueField = "id";
            cboFromToCus.DataTextField = "name";
            cboFromToCus.DataBind();

            cboFromToSupp.DataSource = ObjDb.GetRows("select a.* from (select '0' id,'---Pilih Dari/Untuk---' name union all SELECT distinct noTransKas id, JnsTransKas name FROM mJenisTransaksiKas where noJnsTransKas = '4' and kategoriUsaha is null union all SELECT distinct noTransKas id, JnsTransKas name FROM mJenisTransaksiKas where noJnsTransKas = '4' and kategoriUsaha = '" + ObjSys.GetKategori_Usaha + "') a order by a.id");
            ...
            cbojnskolakte.DataSource = ObjDb.GetRows("select '0' id,' ---Pilih Jenis Kolekte--- ' name union all SELECT distinct nokolekte id, jeniskolekte name FROM mstjeniskolekte_h   ");
            cbojnskolakte.DataValueField = "id";
            cbojnskolakte.DataTextField = "name";
            cbojnskolakte.DataBind();
        }
        #endregion
        ...
        private void SetInitialRowOto(string noTransKas = "0", string noindex = "0")
        {
            DataTable dt = new DataTable();
            DataRow dr = null;
            dt.Columns.Add(new DataColumn("RowNumber", typeof(string)));
            ...
            ObjGlobal.Param.Add("noindex", noindex);
            DataSet mySet = ObjGlobal.GetDataProcedure("SPmRekeningtranskasikaskolekte", ObjGlobal.Param);
        ...
        protected void cboFromToCus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboFromToCus.Text == "1")
                ...
                showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false);
            else  if (cboFromToCus.Text == "50")

                showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false);

            else if (cboFromToCus.Text == "10")

                showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false);

            else if (cboFromToCus.Text == "17")

                showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false);

            else if (cboFromToCus.Text == "19" || cboFromToCus.Text == "20" || cboFromToCus.Text == "21" || cboFromToCus.Text == "22")

                showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToCus.Text == "15")

                showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            if (cboFromToCus.Text == "19" || cboFromToCus.Text == "20" || cboFromToCus.Text == "21" || cboFromToCus.Text == "22" || cboFromToCus.Text == "50")
            {

                loadDataTampKeluar();
                if (cboFromToCus.Text == "19" || cboFromToCus.Text == "20" || cboFromToCus.Text == "21" || cboFromToCus.Text == "22" || cboFromToCus.Text == "50")
                {
                    SetInitialRowOto(cboFromToCus.Text, "0");
                    for (int i = 0; i < grdKasBank.Rows.Count; i++)
                    {
                        TextBox kdRekBank = (TextBox)grdKasBank.Rows[i].Cells[1].FindControl("txtAccount");
        ...
        protected void cboFromToSupp_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboFromToSupp.Text == "1")
                showHideForm(false, false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "2")
                showHideForm(false, true, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
                ...
                showHideForm(false, false, false, true, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "5")
                showHideForm(false, false, false, true, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "6")
                showHideForm(false, false, false, true, false, false, false, false, true, false, true, false, false, false, false, false, false, false, false, false, false);
                ...
                showHideForm(false, false, false, true, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false);
            else if (cboFromToSupp.Text == "51")
            {
            ...
            else if (cboFromToSupp.Text == "52" || cboFromToSupp.Text == "53")
            {
                showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
                ...
                showHideForm(false, false, false, true, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false);
                ...
                if (ObjSys.GetstsPusat == "4")
                    showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false);
            ...
            //     showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, true, false,false,false);
                ...
                if (ObjSys.GetstsPusat == "4")
                    showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false);
                ...
                showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false);

            if (cboFromToSupp.Text == "14" || cboFromToSupp.Text == "51" || cboFromToSupp.Text == "52" || cboFromToSupp.Text == "53" || cboFromToSupp.Text == "21" || cboFromToSupp.Text == "22" || cboFromToSupp.Text == "15" || (cboFromToSupp.Text == "16" && cboTampKeluar.Text != "0"))
            {

                loadDataTampKeluar();
                if (cboFromToSupp.Text == "14" || cboFromToSupp.Text == "15" || cboFromToSupp.Text == "21" || cboFromToSupp.Text == "22" || cboFromToSupp.Text == "51" || cboFromToSupp.Text == "52" || cboFromToSupp.Text == "53")
                {
                    SetInitialRowOto(cboFromToSupp.Text, "0");
                    for (int i = 0; i < grdKasBank.Rows.Count; i++)
                    {
                        TextBox kdRekBank = (TextBox)grdKasBank.Rows[i].Cells[1].FindControl("txtAccount");
                        kdRekBank.Enabled = true;
                        ...
                        if (validate == true)
                        {
                            ...
                            if (Convert.ToDecimal(txtTotalDebit.Text) == Convert.ToDecimal(txtTotalKredit.Text))
                            {
                                ...
                                if (txtAccount2.Text != "")
                                {
                                    ...
                                    {
                                        ObjDb.Data.Add("nojnskolekte", cbojnskolakte.Text);
                                    ...
                                    for (int i = 0; i < grdKasBank.Rows.Count; i++)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            ScriptManager.RegisterClientScriptBlock(this, Page.GetType(), "ToTheTop", "ToTopOfPage();", true);
                                            ShowMessage("error", "Data gagal disimpan, Baris pertama tidak boleh kosong.");
                                        }
        ...
        protected void showHideForm(bool Divcabanggaji, bool DivPO, bool DivCboCust, bool DivCboSupp, bool DivOther, bool DivPR, bool DivGaji, bool DivIuran, bool DivKasBon, bool DivTHR, bool DivAngsuran, bool DivAbsensi, bool DivPRKas, bool DivDanaBOS, bool DivTransfer, bool DivPengembalian, bool DivBPJS, bool DivTampKeluar, bool DivKegiatan, bool divkolekte, bool divjnskolekte)
        {
            ...
            divKolakte.Visible = divjnskolekte;
        ...
        protected void formKolekte_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SetInitialRowOto(cboFromToCus.Text, cbokolekte.Text);
            for (int i = 0; i < grdKasBank.Rows.Count; i++)
            {
                TextBox kdRekBank = (TextBox)grdKasBank.Rows[i].Cells[1].FindControl("txtAccount");
                kdRekBank.Enabled = true;
        ...
        protected void divKolekte_SelectedIndexChanged(object sender, EventArgs e)
        {

            SetInitialRowOto(cboFromToSupp.Text, cbojnskolakte.Text);
            for (int i = 0; i < grdKasBank.Rows.Count; i++)
            {
                TextBox kdRekBank = (TextBox)grdKasBank.Rows[i].Cells[1].FindControl("txtAccount");
                kdRekBank.Enabled = true;
