...
{
    public partial class TransPrestasiInsert : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                message = ObjSys.CreateMessage("Jenis Prestasi harus di pilih.");
                valid = false;
            }
            ...
            try
            {
                ...
                if (valid == true)
                {
                        ...
                        ObjDb.Insert("Transprestasi", ObjDb.Data);
