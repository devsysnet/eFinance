...
{
    public partial class TransPelunasanAR1 : System.Web.UI.Page
    {
        ...
        private void loadDataCombo()
        {
            ...
            cboBank.DataSource = ObjDb.GetRows("select * from ( " +
                ...
                "union " +
                "select norek as id, kdrek+' - '+ket as name from mRekening where jenis = 37 " +
                ")x");
