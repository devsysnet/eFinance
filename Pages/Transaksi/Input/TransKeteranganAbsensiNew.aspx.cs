...
{
    public partial class TransKeteranganAbsensiNew : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            grdKetAbsen.DataSource = ObjGlobal.GetDataProcedure("SPLoaddataabsensiNew", ObjGlobal.Param);
            ...
            try
            {
                ...
                if (valid == true)
                {
                    for (int i = 0; i < grdKetAbsen.Rows.Count; i++)
                    {
                        ...
                        ObjGlobal.ExecuteProcedure("SPUpdateTerlambatAbsensi", ObjGlobal.Param);
