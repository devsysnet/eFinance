...
{
    public partial class TransPengajuanCuti : System.Web.UI.Page
    {
        ...
        protected void grdDataPeminta_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtSaldocuti.Text = grdDataPeminta.Rows[selectedRow].Cells[3].Text;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (dtDatesd.Text == "")
            {
                message = ObjSys.CreateMessage("Tanggal Terakhir Cuti harus di isi.");
                alert = "error";
                valid = false;
            }
            ...
            try
            {
                ...
                if (valid == true)
                {
                    ...
                    ObjGlobal.Param.Add("saldocuti", txtSaldocuti.Text);
                    ObjGlobal.Param.Add("tglmulaicuti", dtDatedr.Text);
                    ObjGlobal.Param.Add("tglselesaicuti", dtDatesd.Text);
                    ...
                    ObjGlobal.ExecuteProcedure("SPInsertTransCuti", ObjGlobal.Param);
