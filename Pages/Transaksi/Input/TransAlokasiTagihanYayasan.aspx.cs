...
{
    public partial class TransAlokasiTagihanYayasan : System.Web.UI.Page
    {
        ...
        {
            //CloseMessage();
            LoadData(txtSearchAsset.Text, cboUnit.Text);
        }

        protected void LoadData(string text,string unit = "0")
        {
            ...
            grdAssetUpdate.DataSource = ObjGlobal.GetDataProcedure("SPLoadAlokasiTagihanyayasan", ObjGlobal.Param);
        ...
        protected void grdAssetUpdate_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "SelectEdit")
                {
                    ...
                    HiddenField hdnnocabangsiswa = (HiddenField)grdAssetUpdate.Rows[rowIndex].FindControl("hdnnocabangsiswa");
                    ObjGlobal.Param.Add("noSiswa", noSiswa);
                    ObjGlobal.Param.Add("nocabang", hdnnocabangsiswa.Value);
