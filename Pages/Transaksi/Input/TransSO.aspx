<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransSO.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransSO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <script type="text/javascript">
        ...
        function Calculate() {
            ...
            //var subTotal2 = 0;
            //if (tipe != "5")
            //{BodyContent_grdPO_konfersiBesar1_1
            for (var i = 1; i < GridView.rows.length; i++) {
                var konfersiBesar = document.getElementById("BodyContent_grdPO_konfersiBesar_".concat(i - 1)).value;
                var konfersiBesar1 = document.getElementById("BodyContent_grdPO_konfersiBesar1_".concat(i - 1)).value;
                var qty = removeMoney(GridView.rows[i].cells[3].getElementsByTagName("INPUT")[0].value) * 1;
                var qtySatuanBesar = removeMoney(GridView.rows[i].cells[5].getElementsByTagName("INPUT")[0].value) * 1;
                var qtySatuanBesar1 = removeMoney(GridView.rows[i].cells[7].getElementsByTagName("INPUT")[0].value) * 1;
                ...
                if (konfersiBesar1 == 0) {
                    if (konfersiBesar == 0) {
                        ...
                        var qtyKecil = ((konfersiBesar * qtySatuanBesar) + qty);
                    }
                } else {
                    var qtyKecil = (((qtySatuanBesar1 * konfersiBesar1) * konfersiBesar) + (konfersiBesar * qtySatuanBesar) + qty);

                }

                   
                GridView.rows[i].cells[10].getElementsByTagName("INPUT")[0].value = money(qtyKecil * unitPrice)
        ...
        {
            var jnstax = document.getElementById("<%=cboTax.ClientID %>").value; 
            var tax = removeMoney(document.getElementById("<%=hdnPersenPPn.ClientID %>").value);
            var subTotal = removeMoney(document.getElementById("BodyContent_txtAmount").value);

            if (jnstax == "Tax") {
                var ppn1 = ((subTotal) * (tax/100)) * 1;
                var Netto = (subTotal+ppn1);
                document.getElementById("<%=txtPPN.ClientID %>").value = money(ppn1);
                        ...
                        <div class="form-horizontal">
                            <div class="form-group row">
                                <div class="form-inline">
                                    <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">SO Date :</label>
                                    <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <asp:DropDownList ID="cboType" class="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboType_SelectedIndexChanged">
                                        <asp:ListItem Value="0">--Pilih Type--</asp:ListItem>
                            ...
                            <div class="form-group row" id="formRek" Visible="false" runat="server">
                                <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">No Rek :</label>
                                <div class="col-sm-5">
                                    <asp:DropDownList ID="cboRek" class="form-control" runat="server" >
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-1">
                                    <asp:Label ID="Label1" runat="server" Text="Hari"></asp:Label>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <asp:DropDownList ID="cboTax" class="form-control" runat="server" OnSelectedIndexChanged="cboTax_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Value="nonTax">Non Pajak</asp:ListItem>
                                        <asp:ListItem Value="Tax">Pajak</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">No Ref</label>
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtNoRef"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <Columns>
                                        ...
                                        <ItemTemplate>
                                            <div class="text-center" style="width:200px;">
                                                <div class="col-md-12">
                                                    ...
                                                    <div style="margin-top:-27px;margin-left:90px;">
                                                  ...
                                                  <asp:HiddenField ID="hdnStok" runat="server" />
                                   ...
                                   <%-- <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="CIF" ItemStyle-Width="10%">
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Satuan Besar" ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <div class="text-center">
                                                  <asp:TextBox runat="server" CssClass="form-control" ID="lblUnitSatuanBesar" Enabled="false"  Width="170"></asp:TextBox>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Satuan Besar 1" ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <div class="text-center">
                                                  <asp:TextBox runat="server" CssClass="form-control" ID="lblUnitSatuanBesar1" Enabled="false"  Width="170"></asp:TextBox>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdProduct" runat="server" SkinID="GridView" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdProduct_PageIndexChanging" OnSelectedIndexChanged="grdProduct_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Stok" HeaderStyle-CssClass="text-center">
                                <ItemTemplate>
                                    <asp:Label ID="lblStok" runat="server" Text='<%# Bind("qty") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
