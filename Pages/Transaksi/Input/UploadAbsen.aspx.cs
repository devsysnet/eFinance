    ...
    public partial class UploadVA : System.Web.UI.Page
    {
                ...
                if (flUpload.HasFile == true)
                {
                    ...
                    if (cboflUpload.Text == "csv/txt")
                    {
                        ...
                        foreach (DataRow row2 in dt.Rows)
                        {
                            ...
                            {
                                using (SqlCommand cmd = new SqlCommand("UpdateDataAbsen"))
                                {
        ...
        public void MyCSV()
        {
            ...
            dt.Columns.AddRange(new DataColumn[5]
            {
                ...
                new DataColumn("nik", typeof(string)),
            ...
            ObjGlobal.Param.Clear();
            ObjGlobal.Param.Add("noCabang", ObjSys.GetCabangId);
            DataSet mySet = ObjGlobal.GetDataProcedure("SPLoadDataAbsKrywn", ObjGlobal.Param);
            foreach (DataRow myRow in mySet.Tables[0].Rows)
            {
                dr = dt.NewRow();
                dr["tgl"] = myRow["tgl"].ToString();
                dr["nik"] = myRow["nik"].ToString();
                dr["nama"] = myRow["nama"].ToString();
