...
{
    public partial class TransPelunasanAR2 : System.Web.UI.Page
    {
            ...
            if (valid == true && count != 0 && selisih == 0)
            {
                try
                {
                    ...
                    if (cabangBisaCetak1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Session["REPORTNAME"] = "PrintKuwitansi2.rpt";
                    ...
                    ObjGlobal.Param.Add("createdBy", ObjSys.GetUserId);
                    ObjGlobal.Param.Add("createdDate", ObjSys.GetNow);
                    ObjGlobal.GetDataProcedure("SPInputKasDetilPelunasan2New", ObjGlobal.Param);
