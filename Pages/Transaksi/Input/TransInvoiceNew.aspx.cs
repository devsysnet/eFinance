...
{
    public partial class TransInvoiceNew : System.Web.UI.Page
    {
        ...
        private void SetInitialRow(string Id = "0")
        {
            ...
            foreach (DataRow myRow in mySet.Tables[0].Rows)
            {
                ...
                dr["txtDiscount"] = ObjSys.IsFormatNumber(myRow["nilaidisc"].ToString());
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (valid == true)
            {
                try
                {
                    ...
                    ObjDb.Data.Clear();
                    if (cbokode.Text == "1")
                        Kode = ObjSys.GetCodeAutoNumberNew("94", Convert.ToDateTime(dtSO.Text).ToString("yyyy-MM-dd"));
                    else
                    ...
                    ObjGlobal.Param.Add("DiskonH", Convert.ToDecimal(txtDiscountH.Text).ToString());
                    ObjGlobal.Param.Add("Total", Convert.ToDecimal(txtSubTotal.Text).ToString());
                    ObjGlobal.Param.Add("Gross", Convert.ToDecimal(txtSubTotal.Text).ToString());
                    ObjGlobal.Param.Add("NilaiPajak", Convert.ToDecimal(txtPPN.Text).ToString());
                    ObjGlobal.Param.Add("nilaiNet", Convert.ToDecimal(txtTotal.Text).ToString());
                    ...
                    if (cbokode.Text == "1")
                    {
                        ObjSys.UpdateAutoNumberCode("94", Convert.ToDateTime(dtSO.Text).ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                        ObjDb.Where.Clear();
