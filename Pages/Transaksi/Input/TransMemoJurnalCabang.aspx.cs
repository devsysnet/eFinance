...
{
    public partial class TransMemoJurnalCabang : System.Web.UI.Page
    {
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (valid == true)
            {
                try
                {
                    string Kode = ObjSys.GetCodeAutoNumber("34", Convert.ToDateTime(dtDate.Text).ToString("yyyy-MM-dd"));
                    ...
                    ObjSys.UpdateAutoNumberCode("34", Convert.ToDateTime(ObjSys.GetNow).ToString("yyyy-MM-dd"));
