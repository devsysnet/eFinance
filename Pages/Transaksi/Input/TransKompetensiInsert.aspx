<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransKompetensiInsert.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransKompetensiInsert" %>
                                    ...
                                    <div class="form-group">
                                        <div class="form-inline">
                                            ...
                                            <div class="col-sm-6">
                                                    ...
                                                    <asp:TextBox ID="txtScore"  runat="server" CssClass="form-control"  />
