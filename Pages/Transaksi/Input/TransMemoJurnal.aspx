<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransMemoJurnal.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransMemoJurnal" %>
                    ...
                    <div class="col-sm-6">
                        <div class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <asp:DropDownList ID="cboType" runat="server" OnSelectedIndexChanged="cboTampKeluar_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
