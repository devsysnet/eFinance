<%@ Page Title="" Async="true" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="CreateUnrequestVA.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.CreateUnrequestVA" %>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label text-left">No VA </label>
                                        <div class="col-sm-5">
                                            <div class="form-inline">
                                                <asp:TextBox ID="txtNamaSiswa" runat="server" CssClass="form-control" placeholder="Masukan No VA"></asp:TextBox>
