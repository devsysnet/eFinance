<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPindahAsset.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransPindahAsset" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Dari Lokasi Barang </label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Dari Sub Lokasi </label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Tgl Pindah Lokasi <span class="mandatory">*</span></label>
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="dtPindah" CssClass="form-control date"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label text-right">Keterangan Pindah <span class="mandatory">*</span></label>
                                <div class="col-sm-7">
