<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPR.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransPR" %>
                            ...
                            <div class="form-horizontal">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group" id="showKatDana" runat="server">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList runat="server" CssClass="form-control" Width="200" ID="cboKategoriDana" AutoPostBack="true" OnSelectedIndexChanged="cboKategoriDana_SelectedIndexChanged">
                                    ...
                                    <div class="form-group" runat="server" id="divDanaBOSH">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="cboDanaH" class="form-control" runat="server" Width="100" AutoPostBack="true" OnSelectedIndexChanged="cboDanaH_SelectedIndexChanged">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-inline">
                                            <label class="col-sm-4 control-label">Tanggal Pelaksanaan <span class="mandatory">*</span></label>
                                            <div class="col-sm-4">
                                                <div class="input-group-btn">
                                                    <asp:TextBox ID="dtDate1" runat="server" class="form-control date"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                    <asp:GridView ID="grdDetail" SkinID="GridView" runat="server" OnRowCommand="grdDetail_RowCommand" OnRowDataBound="grdDetail_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Qty Kecil" ItemStyle-Width="5%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Spesifikasi" ItemStyle-Width="7%">
                                                <ItemTemplate>
                                                    <div class="text-center">
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Dana BOS" ItemStyle-Width="3%">
                                                <ItemTemplate>
                                                    <div class="text-center">
