<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransKeteranganAbsensiNew.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransKeteranganAbsensiNew" %>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdKetAbsen" DataKeyNames="nokaryawan" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="15%" HeaderText="">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                     <asp:DropDownList ID="cboIjin" class="form-control" runat="server">
                                                            <asp:ListItem Value="0" Selected="True">Tidak Potong Gaji</asp:ListItem>
                                                            <asp:ListItem Value="1">Potong Gaji</asp:ListItem>
