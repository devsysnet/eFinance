...
{
    public partial class TransCashAndBank : System.Web.UI.Page
    {
        ...
        protected void LoadDataBank(string kdRek = "")
        {
            ...
            ObjGlobal.Param.Clear();
            ObjGlobal.Param.Add("noCabang", ObjSys.GetCabangId);
            grdIuran.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataCabangnew", ObjGlobal.Param);
            grdIuran.DataBind();

            ObjGlobal.Param.Clear();
            ObjGlobal.Param.Add("noCabang", ObjSys.GetCabangId);
            grdPembayaran.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataCabangnew", ObjGlobal.Param);
            grdPembayaran.DataBind();
            ...
            ObjGlobal.Param.Clear();
            ObjGlobal.Param.Add("noCabang", ObjSys.GetCabangId);
            grdcabanggaji.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataCabangnew", ObjGlobal.Param);
        ...
        protected void cboFromToCus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboFromToCus.Text == "1")
                ...
                showHideForm(false, false, false, true, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToCus.Text == "9")

                showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false);

            else if (cboFromToCus.Text == "10")

                showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false);
            
            else if (cboFromToCus.Text == "17")

                showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false);

            else if (cboFromToCus.Text == "19" || cboFromToCus.Text == "20" || cboFromToCus.Text == "21" || cboFromToCus.Text == "22")

                 showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
                ...
                showHideForm(true,false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
        ...
        protected void cboFromToSupp_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboFromToSupp.Text == "1")
                showHideForm(false, false, false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "2")
                showHideForm(false, false, true, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "3")
                showHideForm(false, false, false, false, true, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "4")
                showHideForm(false, false, false, false, true, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "5")
                showHideForm(false, false, false, false, true, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false);
            
            else if (cboFromToSupp.Text == "6")
                showHideForm(false, false, false, false, true, false, false, false, false, true, false, true, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "18")
                showHideForm(false, true, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
            else if (cboFromToSupp.Text == "22")
                showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true);

            else if (cboFromToSupp.Text == "7")
                showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
            
            else if (cboFromToSupp.Text == "8")
                showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "10")
                showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "11")
                showHideForm(false, false, false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

            else if (cboFromToSupp.Text == "12")
                showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false);

            else if (cboFromToSupp.Text == "13")
                if (ObjSys.GetstsPusat == "4")
                    showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false);
            ...
            else if (cboFromToSupp.Text == "14" || cboFromToSupp.Text == "21")
                showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
           ...
           //     showHideForm(false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false);
                ...
                if (ObjSys.GetstsPusat == "4")
                    showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false);
                ...
                showHideForm(false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false);

            if (cboFromToSupp.Text == "14" || cboFromToSupp.Text == "21"  || cboFromToSupp.Text == "15" || (cboFromToSupp.Text == "16" && cboTampKeluar.Text != "0"))
            {

                loadDataTampKeluar();
                if (cboFromToSupp.Text == "14" || cboFromToSupp.Text == "15" || cboFromToSupp.Text == "21")
                {
                ...
                try
                {
                    ...
                    if (validate == true)
                    {
                        ...
                        if (Convert.ToDecimal(txtTotalDebit.Text) == Convert.ToDecimal(txtTotalKredit.Text))
                        {
                            ...
                            //23 = 
                            {
                                ObjDb.Data.Add("noCus", "23");
                                ObjDb.Data.Add("Cust", "Titipan Pembayaran Siswa");
                                ...
                                if (txtAccount2.Text != "")
                                {
                                    ...
                                    for (int i = 0; i < grdKasBank.Rows.Count; i++)
                                    {
                                        ...
                                        if (txtAccount.Text != "")
                                        {
                                            ...
                                            if (cboFromToSupp.Text == "22")
                                            {
                                                ObjGlobal.Param.Clear();
                                                ObjGlobal.Param.Add("noKas", Id);
                                                ObjGlobal.Param.Add("noRek", hdnAccount.Value);
                                                ObjGlobal.GetDataProcedure("SPudatestsTIuranbln", ObjGlobal.Param);
                                            }
                                            ...
                                            if (cboFromToSupp.Text == "5")
                                            {
                                                ...
                                                ObjGlobal.Param.Add("noRek", hdnAccount.Value);
                                                ObjGlobal.Param.Add("nocabang", ObjSys.GetCabangId);
                                                ObjGlobal.GetDataProcedure("SPudatestsTIuranblnyys", ObjGlobal.Param);
                                            }
                                     ...
                                     if (cboFromToSupp.Text == "18")
                                        {
                                         ObjGlobal.Param.Clear();
                                         ObjGlobal.Param.Add("noKas", Id);
                                         ObjGlobal.GetDataProcedure("SPudateststgajibln", ObjGlobal.Param);
                                        }
                                    ...
                                    if (cboFromToCus.Text == "23")
                                    {
                                        ObjGlobal.Param.Clear();
                                        ObjGlobal.Param.Add("noKas", Id);
                                        ObjGlobal.GetDataProcedure("Spinsertjurnaltitipan", ObjGlobal.Param);
                                    }
        ...
        protected void showHideForm(bool divpenerimaan, bool Divcabanggaji, bool DivPO, bool DivCboCust, bool DivCboSupp, bool DivOther, bool DivPR, bool DivGaji, bool DivIuran, bool DivKasBon, bool DivTHR, bool DivAngsuran, bool DivAbsensi, bool DivPRKas, bool DivDanaBOS, bool DivTransfer, bool DivPengembalian, bool DivBPJS, bool DivTampKeluar, bool DivKegiatan,bool divpembayaran)
        {
            ...
            formpembayaranhutang.Visible = divpembayaran;
        ...
        protected void btnpembayaranhutang_Click(object sender, ImageClickEventArgs e)
        {
            loadData();
            dlgpembayaran.Show();
        }
        ...
        protected void btnSearchPembayaran_Click(object sender, EventArgs e)
        {
            CloseMessage();
            loadData();
            dlgpembayaran.Show();
        ...
        protected void grdPembayaran_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            CloseMessage();
        ...
        protected void grdIuran_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ObjGlobal.Param.Clear();
                ObjGlobal.Param.Add("nocabang", Id);
                ObjGlobal.Param.Add("tgltrsiuran", dtKas.Text);
                DataSet mySetH = ObjGlobal.GetDataProcedure("SPLoadRekeningIurannew", ObjGlobal.Param);
                int i = 0;
                decimal totaldebit = 0;
                for (int x = 1; x < mySetH.Tables[0].Rows.Count; x++)
                {
                    AddNewRow();
                }
                foreach (DataRow myRowH in mySetH.Tables[0].Rows)
                {
                    ...
                    txtAccount.Text = myRowH["kdRek"].ToString();
                    lblDescription.Text = myRowH["Ket"].ToString();
                    txtDebit.Text = ObjSys.IsFormatNumber(myRowH["nilai"].ToString());

                    txtDebit.Enabled = false;
                    totaldebit += Convert.ToDecimal(myRowH["nilai"].ToString());
                }
        ...
        protected void grdPembayaran_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                CloseMessage();

                int rowIndex = grdPembayaran.SelectedRow.RowIndex;
                string Id = grdPembayaran.DataKeys[rowIndex].Values[0].ToString();
                string kodeIuran = grdPembayaran.SelectedRow.Cells[1].Text;

                hdnnopembayaranhutang.Value = Id;
                txtpembayaranhutang.Text = kodeIuran;

                ObjGlobal.Param.Clear();
                ObjGlobal.Param.Add("nocabang", Id);
                ObjGlobal.Param.Add("tgltranhutang", dtKas.Text);
                DataSet mySetH = ObjGlobal.GetDataProcedure("SPLoadRekeningpembayaranhutangcabang", ObjGlobal.Param);
                int i = 0;
                decimal totaldebit = 0;
                for (int x = 1; x < mySetH.Tables[0].Rows.Count; x++)
                {
        ...
        protected void grdcabanggaji_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ObjGlobal.Param.Add("nocabang", Id);
                ObjGlobal.Param.Add("tglTran", dtKas.Text);
                DataSet mySetH = ObjGlobal.GetDataProcedure("SPLoadRekeninggajinew", ObjGlobal.Param);
                int i = 0;
                decimal totaldebit = 0;
                ...
                foreach (DataRow myRowH in mySetH.Tables[0].Rows)
                {
                    ...
                    txtDebit.Text = ObjSys.IsFormatNumber(myRowH["total"].ToString()).ToString();

                    txtDebit.Enabled = false;//gajikaryawan
                    totaldebit = Convert.ToDecimal(txtDebit.Text);
                }
