<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransThrbonus.aspx.cs" Inherits="eFinance.Pages.Transaksi.Input.TransThrbonus" %>
                            ...
                            <div class="col-sm-8">
                                <div class="form-group ">
                                    <div class="form-inline">
                                        <div class="col-sm-12">
                                            <label>Jenis :</label>
                                            <asp:DropDownList ID="cboStatus" runat="server" CssClass="form-control"  Width="200" AutoPostBack="true" OnSelectedIndexChanged="cboStatus_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
