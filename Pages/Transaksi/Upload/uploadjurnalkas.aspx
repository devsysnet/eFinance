<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="uploadjurnalkas.aspx.cs" Inherits="eFinance.Pages.Transaksi.Upload.uploadjurnalkas" %>
                                ...
                                <div class="form-horizontal">
                                    <div class="col-sm-12">
                                       ...
                                       <%-- <div class="form-group" runat="server" id="showhidestatus">
                                            <label class="col-sm-3 control-label">Akun <span class="mandatory">*</span></label>
                                            <div class="col-sm-3">
