<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="uploadjurnalmemo.aspx.cs" Inherits="eFinance.Pages.Transaksi.Upload.uploadjurnalmemo" %>
                                ...
                                <div class="col-sm-8">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <asp:DropDownList ID="cboKategori" runat="server" CssClass="form-control" Width="150"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="form-inline">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <span>Download template upload Jurnal</span>
