...
{
    public partial class ExportImportBudget : System.Web.UI.Page
    {
                ...
                if (flUpload.HasFile == true)
                {
                    ...
                    if (cboStatus.Text == "New")
                    {
                        ...
                        foreach (DataRow row2 in dt.Rows)
                        {
                            ...
                            using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                            {
                                ...
                                using (SqlCommand cmd = new SqlCommand("SPProcessImportBudget"))
                                {
                    ...
                    if (cboStatus.Text == "Revisi")
                    {
                        ...
                        foreach (DataRow row2 in dt.Rows)
                        {
                            ...
                            {
                                using (SqlCommand cmd2 = new SqlCommand("SPProcessImportBudgetRevisi"))
                                {
