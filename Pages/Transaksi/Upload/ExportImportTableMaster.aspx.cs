...
{
    public partial class ExportImportTableMaster : System.Web.UI.Page
    {
        ...
        protected void loadData()
        {
            ...
            cboTabel.DataSource = ObjGlobal.GetDataProcedure("SPLoadTabelExportMaster");
                ...
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            ...
                            cmd.Parameters.Add(new SqlParameter("@bulan", ""));
                            cmd.Parameters.Add(new SqlParameter("@tahun", ""));
