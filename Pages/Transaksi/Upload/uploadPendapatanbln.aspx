<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="uploadPendapatanbln.aspx.cs" Inherits="eFinance.Pages.Transaksi.Upload.uploadPendapatanbln" %>
                                ...
                                <div class="form-horizontal">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group" runat="server" id="tgl">
                                            ...
                                            <div class="col-sm-2">
                                                <asp:TextBox runat="server" CssClass="form-control date" ID="dtpendapatan"></asp:TextBox>
                                            </div>
                                        </div>
