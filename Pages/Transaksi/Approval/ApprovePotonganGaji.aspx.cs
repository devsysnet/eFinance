...
{
    public partial class ApprovePotonganGaji : System.Web.UI.Page
    {
        ...
        protected void loaddata(string tahun = "", string cabang = "")
        {
            ...
            grdGajiKala.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataAprrovepotongan1", ObjGlobal.Param);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (valid == true)
                {
                    string appke = "0";
                    string lvlappr = "1";
                    DataSet mySet = ObjDb.GetRows("select isnull(count(*),0) + 1 as appke from transpotongan_jenjang   where tahun = '" + cboYear.Text + "' and noCabang = '" + cboCabang.Text + "'");
                    ...
                    for (int i = 0; i < grdGajiKala.Rows.Count; i++)
                    {
                        ...
                        DataSet mySet2 = ObjDb.GetRows("select TOP 1 levelApprove as jmllevelapp from MstApprove " +
                            "where noParameterApprove = '11' and noCabang = '" + cboCabang.Text + "' " +
