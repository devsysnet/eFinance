...
{
    public partial class AppvpotonganGajiviewi : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
                    ...
                    for (int i = 0; i < grdGajiKala.Rows.Count; i++)
                    {
                        ...
                        string levelAppv = "";
                            ...
                            if (levelAppv == hdnlvlApprove.Value)
                            {
                                ...
                                ObjDb.Data.Add("nilai", txtKeterangan.Text);
            ...
            //            if (statusRjt == "1")
            //            {
            //                ObjGlobal.ExecuteProcedure("SPUpdateStspotongan", ObjGlobal.Param);
            //            }
            //            else
            //            {
            //                ObjGlobal.ExecuteProcedure("SPInsertApprovePotongan", ObjGlobal.Param);
            //            }
            //        }
            //    }
