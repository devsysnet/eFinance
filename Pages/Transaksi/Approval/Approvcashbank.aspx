<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Approvcashbank.aspx.cs" Inherits="eFinance.Pages.Transaksi.Approval.Approvcashbank" %>
                            ...
                            <div class="form-horizontal">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <asp:TextBox CssClass="form-control" runat="server" ID="Type" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
