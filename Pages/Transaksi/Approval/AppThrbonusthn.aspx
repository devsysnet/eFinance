<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="AppThrbonusthn.aspx.cs" Inherits="eFinance.Pages.Transaksi.Approval.AppThrbonusthn" %>
                            ...
                            <div class="table-responsive overflow-x-table">
                                <asp:GridView ID="grdGajiKala" DataKeyNames="notransaksi" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Pendapatan" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="right">
                                            <ItemTemplate>
