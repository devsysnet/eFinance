<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransApproveGaji.aspx.cs" Inherits="eFinance.Pages.Transaksi.Approval.TransApproveGaji" %>
                                ...
                                <asp:GridView ID="grdGajiKala" DataKeyNames="notransaksi" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nama Karyawan" ItemStyle-Width="30%">
                                         ...
                                         <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Jenis Potongan" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAlert" runat="server" Text='<%# Bind("komponengaji") %>' Width="150"></asp:Label>
                                                </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="false" HeaderStyle-CssClass="text-center" HeaderText="Potongan" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="right">
                                            <ItemTemplate>
                                      ...
                                      <%--  <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Level" ItemStyle-Width="15%">
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Potongan" ItemStyle-Width="1%">
                                            <ItemTemplate>
                                                <div class="text-center">
