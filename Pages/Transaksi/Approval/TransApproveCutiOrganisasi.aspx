<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransApproveCutiOrganisasi.aspx.cs" Inherits="eFinance.Pages.Transaksi.Approval.TransApproveCutiOrganisasi" %>
                            ...
                            <div class="table-responsive overflow-x-table" id="pajak"  runat="server">
                                <asp:GridView ID="grdBudget" SkinID="GridView" runat="server">
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    ...
                                                    <asp:HiddenField ID="hdnnorganisasi" runat="server" Value='<%# Bind("noorganisasi") %>'  />
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Uraian" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-left">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("uraian") %>' ID="txtApril" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Total Cuti" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-left">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("totalcuti") %>' ID="txtApril1" Width="50"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Saldo Cuti" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-left">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("saldocuti") %>' ID="txtApril2" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
