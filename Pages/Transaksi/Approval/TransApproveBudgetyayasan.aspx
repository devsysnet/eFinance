<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransApproveBudgetyayasan.aspx.cs" Inherits="eFinance.Pages.Transaksi.Approval.TransApproveBudgetyayasan" %>
                            ...
                            <div class="tableFixHead table-responsive overflow-x-tablee" id="pajak" visible="false" runat="server">
                                <asp:GridView ID="grdBudget" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Januari Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                           ...
                                           <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Januari Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi1", "{0:#,0.00}") %>' ID="txtJanuarirevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Februari Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                           ...
                                           <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Februari Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi2", "{0:#,0.00}") %>' ID="txtFebuarirevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Maret Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                           ...
                                           <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Maret Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi3", "{0:#,0.00}") %>' ID="txtMaretrevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="April Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                           ...
                                           <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="April Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi4", "{0:#,0.00}") %>' ID="txtAprilrevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Mei Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                           ...
                                           <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Mei Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi5", "{0:#,0.00}") %>' ID="txtMeirevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Juni Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                           ...
                                           <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Juni Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi6", "{0:#,0.00}") %>' ID="txtJunirevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Juli Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                           ...
                                           <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Juli Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi7", "{0:#,0.00}") %>' ID="txtJulirevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Agustus Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                          ...
                                          <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Agustus Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi8", "{0:#,0.00}") %>' ID="txtAgustusrevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="September Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                          ...
                                          <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="September Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi9", "{0:#,0.00}") %>' ID="txtSeptemberrevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Oktober Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                          ...
                                          <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Oktober Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi10", "{0:#,0.00}") %>' ID="txtOktoberrevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="November Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                          ...
                                          <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="November Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi11", "{0:#,0.00}") %>' ID="txtNovemberrevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Desember Lama" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                          ...
                                          <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Desember Revisi" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:Label runat="server" class="control-label" Text='<%# Eval("budgetrevisi12", "{0:#,0.00}") %>' ID="txtDesemberrevisi" Width="130"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
