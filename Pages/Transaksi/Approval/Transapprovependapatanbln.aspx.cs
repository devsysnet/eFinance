...
{
    public partial class Transapprovependapatanbln : System.Web.UI.Page
    {
        ...
        protected void loaddata(string tahun = "", string cabang = "")
        {
            ...
            grdGajiKala.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataAprrovependapatanbln", ObjGlobal.Param);
        ...
        protected void cboCabang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataSet mySetaa = ObjDb.GetRows("select distinct nouser from Transpeendapatan_Jenjang where nocabang = '" + cboCabang.Text + "' and nouser = '" + nouser + "'");
