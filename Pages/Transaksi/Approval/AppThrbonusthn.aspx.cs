...
{
    public partial class AppThrbonusthn : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            ObjGlobal.Param.Add("noParameter", "10");
            grdGajiKala.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataAprrovePendapatanthn", ObjGlobal.Param);
                ...
                if (valid == true)
                {
                    for (int i = 0; i < grdGajiKala.Rows.Count; i++)
                    {
                        ...
                        if (chkCheck.Checked == true)
                        {
                            ...
                            DataSet mySet = ObjDb.GetRows("select TOP 1 b.levelApprove from Tthrkaryawan a " +
                            "inner join MstApprove b on b.noParameterApprove = '10' where " +
                            "a.nocabang = b.nocabang and a.nothr='" + hdnnotransgaji.Value + "' ORDER BY b.levelApprove DESC");
                            ...
                            if (levelAppv == hdnlvlApprove.Value)
                            {
                                ...
                                ObjDb.Data.Clear();
                                ObjDb.Where.Clear();
                                ObjDb.Where.Add("nothr", hdnnotransgaji.Value);
                                ObjDb.Data.Add("stsapv", "1");
                                ObjDb.Update("Tthrkaryawan", ObjDb.Data, ObjDb.Where);
                            }
                            ...
                            if (rdoApprove.Checked == true)
                            {
                                ...
                                ObjDb.Insert("Transpendapatanthn_Jenjang", ObjDb.Data);
                            }
                            ...
                            {
                                string sql1 = "update Tthrkaryawan set stsapv = '2' where nothr = '" + hdnnotransgaji.Value + "'";
                                ObjDb.ExecQuery(sql1);

                                string sql2 = "delete Transpendapatanthn_Jenjang where notransgaji = '" + hdnnotransgaji.Value + "'";
                                ...
                                ObjDb.Insert("Transpendapatanthn_JenjangReject", ObjDb.Data);
                            }
                        }
            ...
            try
            {
                ...
                for (int i = 0; i < grdGajiKala.Rows.Count; i++)
                {
                    ...
                    if (chkCheck.Checked == true && (rdoApprove.Checked == true || rdoReject.Checked == true))
                    {
                        ...
                        if (statusRjt == "1")
                        {
                            ObjGlobal.ExecuteProcedure("SPUpdateStspendapatanthn", ObjGlobal.Param);
                        }
                        else
                        {
                            ObjGlobal.ExecuteProcedure("SPInsertApprovePendapatanthn", ObjGlobal.Param);
                        }
                    }
                }
