...
{
    public partial class TranspotonganGajiupdate : System.Web.UI.Page
    {
        ...
        protected void loadDataFirst(string perwakilan = "0", string unit = "0")
        {
            ...
            grdKelasSiswa.DataSource = ObjGlobal.GetDataProcedure("SPLoadDatapotongangajiupdate", ObjGlobal.Param);
