...
{
    public partial class TransAssetUpdate : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            grdAssetUpdate.DataSource = ObjGlobal.GetDataProcedure("SPLoadAssetUpdate", ObjGlobal.Param);
            ...
            if (valid == true)
            {
                try
                {
                    if (cbojnsBarang.Text == "1")
                    {
                        ...
                        ObjGlobal.Param.Add("tgltempo", dttgl.Text);
