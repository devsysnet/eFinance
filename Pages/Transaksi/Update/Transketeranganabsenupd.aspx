<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Transketeranganabsenupd.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.Transketeranganabsenupd" %>
                                ...
                                <asp:GridView ID="grdKetAbsen" DataKeyNames="nokaryawan" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" ItemStyle-Width="20%" HeaderText="Keterangan">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox ID="txtKeterangan"  runat="server" TextMode="MultiLine" class="form-control" Text='<%# Bind("keterangan") %>'></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                         </asp:TemplateField>
                                    </Columns>
