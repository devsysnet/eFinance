...
{
    public partial class Transketeranganabsenupd : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            grdKetAbsen.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataKeteranganAbsen", ObjGlobal.Param);
            ...
            try
            {
                ...
                if (valid == true)
                {
                    for (int i = 0; i < grdKetAbsen.Rows.Count; i++)
                    {
                        ...
                        ObjGlobal.ExecuteProcedure("SPUpdateijinabsen", ObjGlobal.Param);
