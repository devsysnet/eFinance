<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransLokasiAssetUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransLokasiAssetUpdate" %>
                    ...
                    <div id="tabGrid" runat="server">
                        <div class="form-horizontal">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="cboSubLokasi" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboSubLokasi_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdLokasiAsset" DataKeyNames="noAset" SkinID="GridView" runat="server" >
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="No." ItemStyle-Width="1%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            ...
                                                            <asp:HiddenField ID="hdnrekDb" runat="server" Value='<%# Bind("norekdb") %>' />
                                                            <asp:HiddenField ID="hdnrekKd" runat="server" Value='<%# Bind("norekkd") %>' />
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Lokasi" ItemStyle-Width="12%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:DropDownList ID="cboLokasiBaru" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboLokasiBaru_SelectedIndexChanged"></asp:DropDownList>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Sub Lokasi" ItemStyle-Width="12%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:DropDownList ID="cboSubLokasiBaru" runat="server"></asp:DropDownList>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            ...
                            <div class="row" id="button" runat="server">
                                <div class="col-sm-12 ">
                                    <div class="text-center">
                                        <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-success" Text="Hapus" OnClick="btnDelete_Click" UseSubmitBehavior="false" OnClientClick="this.disabled = true; this.value = 'Proses...';" />
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Ubah" OnClick="btnSubmit_Click" UseSubmitBehavior="false" OnClientClick="this.disabled = true; this.value = 'Proses...';" />
