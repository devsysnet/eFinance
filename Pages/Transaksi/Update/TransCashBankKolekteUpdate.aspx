<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransCashBankKolekteUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransCashBankKolekteUpdate" %>
                            ...
                            <div class="col-sm-12">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:DropDownList runat="server" Enabled="false" ID="cbokolekte" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="formKolekte_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                </div>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdBank" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdBank_PageIndexChanging" OnSelectedIndexChanged="grdBank_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="text-left" HeaderText="Description" ItemStyle-Width="20%">
                                <ItemTemplate>
                                    <div class="text-left">
