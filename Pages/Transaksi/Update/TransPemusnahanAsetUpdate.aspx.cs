...
{
    public partial class TransPemusnahanAsetUpdate : System.Web.UI.Page
    {
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (valid == true)
            {
                try
                {
                    ...
                    ObjGlobal.Param.Add("tglMusnah", Convert.ToDateTime(dtMusnah.Text).ToString("yyyy-MM-dd"));
                    ObjGlobal.Param.Add("alasan", txtAlasan.Text);
                    ObjGlobal.Param.Add("modiby", ObjSys.GetUserId);
                    ObjGlobal.GetDataProcedure("SPUpdatePemusnahanAset", ObjGlobal.Param);
