...
{
    public partial class TransTerimaBarangUpdate : System.Web.UI.Page
    {
        ...
        private void SetInitialRow(string Id = "")
        {
            ...
            dt.Columns.Add(new DataColumn("hdnJnsPR", typeof(string)));
            ...
            foreach (DataRow myRow in mySet.Tables[0].Rows)
            {
                ...
                dr["hdnJnsPR"] = myRow["jenis"].ToString();
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        HiddenField hdnJnsPR = (HiddenField)grdReceive.Rows[i].FindControl("hdnJnsPR");
        ...
        protected void grdReceiveUpdate_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "SelectEdit")
                {
                    ...
                    DataSet myData = ObjDb.GetRows("select a.*,c.jenis,b.noPO from  TransReceive_H a inner join " +
                        "TransPR_D b on a.noPRD = b.noPRD inner join TransPR_H c on c.noPR = b.noPR " +
                        "where a.noTerima = '" + id + "'");
