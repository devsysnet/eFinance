<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransGiroUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransGiroUpdate" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdAssetUpdate" DataKeyNames="nodeposito" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdAssetUpdate_PageIndexChanging" OnRowCommand="grdAssetUpdate_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="kdTransaksi" HeaderText="Kode Transaksi" HeaderStyle-CssClass="text-center" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="left"/>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:DropDownList ID="cbojenistransaksi" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboLokasi_SelectedIndexChanged" Width="180">
                                 ...
                                 <div class="col-sm-4" id="showhidekode" runat="server">
                                     <asp:DropDownList runat="server" AutoPostBack="false"  CssClass="form-control" ID="cborekeningbank" Width="180">                                          
                                      </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                     <asp:DropDownList runat="server" AutoPostBack="false"  CssClass="form-control" ID="cbojenissrt" Width="120">                                          
                                      </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-inline">
                                    <div class="col-sm-5">
                                         <asp:DropDownList ID="cbojnsbunga" runat="server" Width="100">
