...
{
    public partial class TransCashBankKolekteUpdate : System.Web.UI.Page
    {
        ...
        protected void loadDataFirst()
        {
            ...
            grdKas.DataSource = ObjGlobal.GetDataProcedure("SPViewKasBankUpdatekolekte", ObjGlobal.Param);
            grdKas.DataBind();
        }
        ...
        protected void grdKas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "SelectEdit")
                {
                    ...
                    hdnValue.Value = ObjSys.IsFormatNumber(myRow["Nilai"].ToString());
                    txtKurs.Text = myRow["kursKas"].ToString();
                    ...
                    if (cboTransaction.Text == "1")
                    {
                        ...
                        formFromToCus.Visible = true;
                        forFormToSupp.Visible = false;
                    }
                    else
                    {
                        cboFromToSupp.Text = myRow["dari"].ToString();
                        formFromToCus.Visible = false;
                        forFormToSupp.Visible = true;
                    }
