...
{
    public partial class TransCashBankUnitUpdate : System.Web.UI.Page
    {
        ...
        protected void loadDataFirst()
        {
            ...
            grdKas.DataSource = ObjGlobal.GetDataProcedure("SPViewKasBankunitUpdate", ObjGlobal.Param);
            grdKas.DataBind();
        }
        ...
        private void SetInitialRow(string Id = "")
        {
            ...
            DataSet mySet = ObjGlobal.GetDataProcedure("SPViewKasBankDnew", ObjGlobal.Param);
            ...
            foreach (DataRow myRow in mySet.Tables[0].Rows) 
            {
                ...
                dr["cbocabangunit"] = myRow["nocabang"].ToString();
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        cbocabangunit.DataSource = ObjDb.GetRows("select a.* from (select nocabang id,namacabang name,noUrut FROM vCabang WHERE nocabang = '" + ObjSys.GetCabangId + "' union all SELECT distinct nocabang id, namaCabang name, noUrut FROM vCabang WHERE stsCabang in (2,3) and parent = '" + ObjSys.GetParentCabang + "' and nocabang != '" + ObjSys.GetCabangId + "') a order by a.noUrut");
        ...
        protected void LoadAwal()
        {
            ...
            if (cboTransaction.Text == "1")
            {
                ...
                showHideForm(false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
                if (cboFromToCus.Text == "1")
                    ...
                    showHideForm(false, true, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false);

                else if (cboFromToCus.Text == "10")
                    showHideForm(false, true, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false);
                else if (cboFromToCus.Text == "50")
                    showHideForm(false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false,true);

                else if (cboFromToCus.Text == "17")
                    showHideForm(false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false);
            }
            else if (cboTransaction.Text == "2")
            {
                ...
                if (cboFromToSupp.Text == "1")
                    showHideForm(false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);

                else if (cboFromToSupp.Text == "2")
                    showHideForm(true, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
                    ...
                    showHideForm(false, false, true, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false);
                    
                else if (cboFromToSupp.Text == "5")
                    showHideForm(false, false, true, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false);
                    
                else if (cboFromToSupp.Text == "6")
                    showHideForm(false, false, true, false, false, false, false, true, false, true, false, false, false, false, false, false, false, false, false);

                else if (cboFromToSupp.Text == "7")
                    showHideForm(false, false, true, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, false);
                    
                else if (cboFromToSupp.Text == "8")
                    showHideForm(false, false, true, false, false, false, false, true, false, false, true, false, false, false, false, false, false, false, false);

                else if (cboFromToSupp.Text == "10")
                    showHideForm(false, false, true, false, false, false, false, true, false, false, false, false, true, false, false, false, false, false, false);
                    ...
                    if (ObjSys.GetstsPusat == "4")
                        showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false);
                    ...
                    showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false);
                
                else if (cboFromToSupp.Text == "16")
                    showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false);

                else if (cboFromToSupp.Text == "17")
                    showHideForm(false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false);

            }
        }
        
        protected void showHideForm(bool DivPO, bool DivCboCust, bool DivCboSupp, bool DivOther, bool DivPR, bool DivGaji, bool DivIuran, bool DivKasBon, bool DivTHR, bool DivAngsuran, bool DivAbsensi, bool DivPRKas, bool DivDanaBOS, bool DivTransfer, bool DivPengembalian, bool DivBPJS, bool DivTampKeluar, bool DivKegiatan,bool divkolekte)
        {
        ...
        protected void cboFromToSupp_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboFromToSupp.Text == "1")
                ...
                showHideForm(false, false, true, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false);
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            {
                DataSet dataSaldobln1 = ObjDb.GetRows("select distinct month(tgl) as bln from tsaldobln where noCabang = '" + ObjSys.GetCabangId + "' and sts=0 and year(tgl)='" + Convert.ToDateTime(dtKas.Text).Year + "'");
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    for (int i = 0; i < dtCurrentTable.Rows.Count; i++)
                    {
                        ...
                        dtCurrentTable.Rows[i]["cbocabangunit"] = ObjSys.GetCabangId;
