...
{
    public partial class TransPelunasanARDelete : System.Web.UI.Page
    {
            ...
            try
            {
                if (hdnMode.Value.ToLower() == "deleteall")
                {
                    ...
                    if (arrayItem != null)
                    {
                        ...
                        {
                            ObjDb.Where.Clear();
                            ObjDb.Where.Add("noPiutang", itemRow);
                            ObjDb.Delete("TransPiutang", ObjDb.Where);
                            
                        }
                    }
                    foreach (GridViewRow gvrow in grdARSiswa.Rows)
                    {
                        string itemId = grdARSiswa.DataKeys[gvrow.RowIndex].Value.ToString();
                        CheckBox chkCheck = (CheckBox)grdARSiswa.Rows[gvrow.RowIndex].FindControl("chkCheck");
                        if (chkCheck.Checked == true)
                        {

                            ObjDb.Where.Clear();
                            ObjDb.Where.Add("noPiutang", itemId);
                            ObjDb.Delete("TransPiutang", ObjDb.Where);
                        }
                    }
                }
        ...
        protected void loadDataFirst()
        {
            ...
            grdARSiswa.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataPelunasanARDelete", ObjGlobal.Param);
            grdARSiswa.DataBind();
