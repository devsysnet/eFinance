<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransInvoiceGenUpdate.aspx.cs" Inherits="eFinance.Pages.Transaksi.Update.TransInvoiceGenUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    function Calculate() {
                ...
                if (tax == "1") {
                     if (pph23 == "1") {
                        ...
                        document.getElementById("<%=txtsubtotal1.ClientID %>").value = money(subtotal1);
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <asp:DropDownList ID="cboCurrency" class="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboCurrency_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group row">
                                <label for="pjs-ex1-fullname" class="col-sm-4 control-label text-right">Potongan PPH :</label>
                                <div class="col-sm-8">
                                  <asp:DropDownList runat="server" CssClass="form-control" ID="cbopph" OnSelectedIndexChanged="cboTax_SelectedIndexChanged" AutoPostBack="true" Width="100">
                                        <asp:ListItem Value="1">Yes</asp:ListItem>
                                        <asp:ListItem Value="2">No</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                ...
                                <asp:GridView ID="grdSOD" SkinID="GridView" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Qty" ItemStyle-Width="6%">
                                            <ItemTemplate>
                                                <div class="text-center">
                                                    <asp:TextBox runat="server" CssClass="form-control money" Text="0.00" ID="txtQty" onblur="return Calculate(event);" ></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Unit Price" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <div class="text-right">
                                                    <asp:TextBox runat="server" CssClass="form-control money" Text="0.00" ID="txtUnitPrice" onblur="return Calculate(event);" ></asp:TextBox>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <div class="col-sm-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="form-inline">
                                        ...
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtAmount" Enabled="false" runat="server" CssClass="form-control money"  Text="0.00" onblur="return CalculateTotal(event);" Width="200"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <asp:TextBox runat="server" CssClass="form-control money" ID="txtpph" Text="0.00" Enabled="false" Width="200"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="pjs-ex1-fullname" class="col-sm-10 control-label text-right">Sub Total :</label>
                            <div class="col-sm-2">
                                <asp:TextBox runat="server" CssClass="form-control money" ID="txtsubtotal1" Text="0.00" Enabled="false" Width="200"></asp:TextBox>
                            </div>
                        </div>
                          <div class="form-group">
                                    <div class="form-inline">
                            ...
                            <div class="col-sm-2">
                                <asp:TextBox runat="server" CssClass="form-control money" ID="txtPPN" Text="0.00"  Enabled="false" Width="200"></asp:TextBox>
                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-inline">
                                        ...
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtTotalAmount" runat="server" Enabled="false" CssClass="form-control money"  Text="0.00" onblur="return CalculateTotal(event);" Width="200"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <asp:LinkButton ID="LinkButton2" runat="server" Style=""></asp:LinkButton>
       <asp:ModalPopupExtender ID="dlgBank" runat="server" PopupControlID="panelAddDataBank" TargetControlID="LinkButton2" BackgroundCssClass="modal-background">
        </asp:ModalPopupExtender>
