...
{
    public partial class TransMutasiKaryawanView : System.Web.UI.Page
    {
        ...
        protected void grdPinjaman_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "SelectEdit")
                {
                    ...
                    else if (myRow["kategori"].ToString() == "Promosi" || myRow["kategori"].ToString() == "Demosi" || myRow["kategori"].ToString() == "MutasiJabatan")
                    {
                        formpindah.Visible = false;
                        formjabatan.Visible = true;
                    }
