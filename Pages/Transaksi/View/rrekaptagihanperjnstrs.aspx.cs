...
{
    public partial class rrekaptagihanperjnstrs : System.Web.UI.Page
    {
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("SPRReportrekapjenisbyr", con);
                            ...
                            String fileName = "Rekap_jnsbayar_" + ObjSys.GetNow + ".xls";
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPRReportrekapjenisbyr", ObjGlobal.Param);
            grdAccount.DataBind();
