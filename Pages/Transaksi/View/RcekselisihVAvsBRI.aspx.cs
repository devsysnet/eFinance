...
{
    public partial class RcekselisihVAvsBRI : System.Web.UI.Page
    {
            ...
            try
            {
                if (valid == true)
                {
                    ...
                    try
                    {
                        ...
                        DataSet dataSet = ObjGlobal.GetDataProcedure("SPVaBRIvsSAK", ObjGlobal.Param);


                        String fileName = "report_VA_vs_BRI" + ObjSys.GetNow + ".xls";
        ...
        protected void btnPosting_Click(object sender, EventArgs e)
        {
            ObjGlobal.Param.Clear();
            ObjGlobal.Param.Add("nocabang", cboPerwakilan.Text);
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPVaBRIvsSAK", ObjGlobal.Param);
            grdAccount.DataBind();
