<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransKompetensiView.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.TransKompetensiView" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdPRUpdate" DataKeyNames="noTransKompetensi" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPRUpdate_PageIndexChanging" OnRowCommand="grdPRUpdate_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Kompetensi" HeaderText="Jenis Kompetensi" HeaderStyle-CssClass="text-center" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="center" />
                                            <asp:BoundField DataField="tglKompetensi" HeaderText="Tgl Kompetensi" HeaderStyle-CssClass="text-center" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}" />
                                            <asp:BoundField DataField="skor" HeaderText="Skor" HeaderStyle-CssClass="text-center" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="center" />
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group" id="showProject" runat="server">
                                        <label class="col-sm-4 control-label">Jenis Kompetensi <span class="mandatory">*</span></label>
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="cboProject" runat="server" CssClass="form-control" Enabled="false" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Tanggal Kompetensi <span class="mandatory">*</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-inline">
                                            <label class="col-sm-4 control-label">Skor <span class="mandatory">*</span></label>
                                            <div class="col-sm-6">
                                                  <asp:TextBox ID="txtSkor" Enabled="false"  Width="100" runat="server" CssClass="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtKeterangan" Enabled="false"  runat="server" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
