<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPenjualanObatView.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.TransPenjualanObatView" %>
                ...
                <asp:GridView ID="grdReceiveUpdate" DataKeyNames="noPenjualan" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdReceiveUpdate_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="" HeaderStyle-CssClass="text-center" ItemStyle-Width="1%">
                            ...
                            <ItemTemplate>
                                <div class="text-center">
                                    <asp:Button ID="btnSelectDel" runat="server" style="display:none;"  class="btn btn-xs btn-labeled btn-danger" Text="Hapus" CommandName="SelectDelete" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>' CausesValidation="false" />
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
            ...
            <div class="col-sm-12">
                <div class="panel">
                            ...
                            <asp:GridView ID="grdReceive" SkinID="GridView" runat="server" OnRowDataBound="grdReceive_RowDataBound"  OnRowCommand="grdReceive_RowCommand">
                                <Columns>
                                            ...
                                            <div class="form-group">
                                                <div class="form-inline">
                                                    <div class="text-center">
                                                        ...
                                                        <asp:ImageButton ID="btnImgAccount" style="display:none;"  runat="server" ImageUrl="~/assets/images/icon_search.png" CssClass="btn-image form-control" CommandName="Select" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>' />
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="QTY" ItemStyle-Width="1%">
                                        <ItemTemplate>
                                            <div class="text-center">
                                                <asp:TextBox runat="server" Enabled="false" class="form-control text-center money" ID="txtQTY"  Width="80"  onblur="return Calculate(event);"></asp:TextBox>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <asp:Button runat="server" style="display:none;" ID="btnSimpan" CssClass="btn btn-primary" Text="Ubah" OnClick="btnSimpan_Click" UseSubmitBehavior="false" OnClientClick="this.disabled = true; this.value = 'Proses...';"></asp:Button>
