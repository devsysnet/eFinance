...
{
    public partial class Rperubahanmodal : System.Web.UI.Page
    {
        ...
        protected void loadData(string unit = "0")
        {
            ...
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPviewPerubahanModal", ObjGlobal.Param);
            grdAccount.DataBind();
        }
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Session["REPORTNAME"] = "RperubahanmodalPrint.rpt";
