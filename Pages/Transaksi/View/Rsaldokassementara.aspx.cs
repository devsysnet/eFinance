...
{
    public partial class Rsaldokassementara : System.Web.UI.Page
    {
        ...
        protected void loadData()
        {
            ...
            ObjGlobal.Param.Add("nocabangfilter", cboCabang.Text);
            grdHarianGL.DataSource = ObjGlobal.GetDataProcedure("SPLoadDatasaldokassementara", ObjGlobal.Param);
            ...
            try
            {
                if (valid == true)
                {
                    ...
                    try
                    {
                        ObjGlobal.Param.Clear();
                        ObjGlobal.Param.Add("nocabangfilter", cboCabang.Text);
                        DataSet dataSet = ObjGlobal.GetDataProcedure("SPLoadDatasaldokassementara", ObjGlobal.Param);
                       
                        String fileName = "saldo_kassementara_" + ObjSys.GetNow + ".xls";
