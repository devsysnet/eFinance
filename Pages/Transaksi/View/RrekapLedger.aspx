<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RrekapLedger.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RrekapLedger" %>
...
<%--                        <label>Unit : </label>--%>
                        <asp:DropDownList  ID="cboCabang" Width="200" runat="server" CssClass="form-control"></asp:DropDownList>
