<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RCekTagihanvsGL.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RCekTagihanvsGL" %>
                    ...
                    <Columns>
                       ...
                       --%>
                        <asp:TemplateField HeaderText="Jenis Transaksi" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="left">
                         ...
                         <asp:TemplateField HeaderText="Nama Cabang" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="left">
                            <ItemTemplate>
                                <asp:Label ID="Grup" runat="server" Text='<%# Eval("namaCabang") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Tahun" SortExpression="Ket" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="center">
                            <ItemTemplate>
                                <asp:Label ID="Grup" runat="server" Text='<%# Eval("thn") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Nilai Tagihan" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                            <ItemTemplate>
                                <asp:Label ID="Grup" runat="server" Text='<%# Eval("nilaitagihan") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Nilai Jurnal" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                            <ItemTemplate>
                                <asp:Label ID="Grup" runat="server" Text='<%# Eval("nilaijurnal") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Selisih" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                            <ItemTemplate>
                                <asp:Label ID="Grup" runat="server" Text='<%# Eval("selisih") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
