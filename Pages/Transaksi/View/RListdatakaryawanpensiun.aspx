<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RListdatakaryawanpensiun.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RListdatakaryawanpensiun" %>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdSaldoGLDetil" SkinID="GridView" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="kdrek" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                ...
                                                <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Nilai" ItemStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:TextBox ID="txtnilai" runat="server" CssClass="form-control money" Text='<%# Bind("nilai","{0:n2}") %>' Enabled="false"></asp:TextBox>
                                                         </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
