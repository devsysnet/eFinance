<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Rlistblmsetorparoki.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.Rlistblmsetorparoki" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdSiswa" DataKeyNames="nokas" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdSiswa_PageIndexChanging" OnRowCommand="grdSiswa_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="namaCabang" HeaderText="Paroki" HeaderStyle-CssClass="text-center" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="pjs-ex1-fullname" class="col-sm-3 control-label">Paroki </label>
                                        <div class="col-sm-5">
                                             <asp:TextBox runat="server" class="form-control " ID="namacabang" type="text" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                    <div class="col-md-12">
