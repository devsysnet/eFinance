...
{
    public partial class RDetailtagihansiswa : System.Web.UI.Page
    {
                ...
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                               ...
                               cmd = new SqlCommand("SPRReportdetailbayarsiswa", con);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            tabelDinamis(ObjGlobal.GetDataProcedure("SPRReportdetailbayarsiswa", ObjGlobal.Param));
