<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPinjamanView.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.TransPinjamanView" %>
            ...
            <div class="col-sm-12 overflow-x-table">
                <asp:GridView ID="grdKas" DataKeyNames="nokaryawan" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdKas_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="KodePinjam" SortExpression="KodePinjam" HeaderText="Kode Transaksi" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" />
                        <asp:BoundField DataField="nama" SortExpression="nama" HeaderText="Nama Karyawan" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                        ...
                        <asp:BoundField DataField="uraian" SortExpression="uraian" HeaderText="Uraian" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                        <asp:BoundField DataField="nilai" SortExpression="nilai" HeaderText="Nilai Pinjaman" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right" />
                        <asp:BoundField DataField="angsuran" SortExpression="nilai" HeaderText="Lama Angsuran" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right" />
                    </Columns>
                </asp:GridView>
              </div>
             <div class="form-group row">
                    <div class="col-md-12">
                        <div class="text-center">
                               <%--<asp:Button runat="server" ID="Button1" CssClass="btn btn-danger" Text="Back" OnClick="btnReset_Click"></asp:Button>--%>
                         </div>
                    </div>
             </div>
        </div>
