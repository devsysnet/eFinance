...
{
    public partial class RRekaptransaksi : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            grdRekap.DataSource = ObjGlobal.GetDataProcedure("SPLoadDatarekapjnsbayar", ObjGlobal.Param);
            grdRekap.DataBind();
        ...
        protected void grdRekap_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "SelectEdit")
                {
                    ...
                    ObjGlobal.Param.Add("nocabang", cboCabang.Text);
                    ObjGlobal.Param.Add("tgl", Convert.ToDateTime(hdntgl.Value).ToString("yyyy-MM-dd"));
