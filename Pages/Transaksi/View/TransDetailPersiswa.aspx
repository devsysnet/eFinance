<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransDetailPersiswa.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.TransDetailPersiswa" %>
...
<script type="text/javascript">
    function ExportToExcel(type, fn, dl) {
        ...
        return dl ?
            ...
            XLSX.writeFile(wb, fn || ('detailpersiswa.' + (type || 'xlsx')));
    }
</script>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 overflow-x-table">
                                        ...
                                        <asp:GridView ID="grdDownloadARSiswa" SkinID="GridView" runat="server">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Nama Siswa" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="noVirtual" runat="server" Text='<%# Eval("namasiswa").ToString() %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
