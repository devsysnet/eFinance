<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="MProjectView.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.MProjectView" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group ">
                                    <div class="form-inline">
                                        <div class="col-sm-12">
                                            <asp:DropDownList ID="cboCabang" class="form-control" runat="server" Width="250"></asp:DropDownList>
                    ...
                    <div id="tabForm" runat="server" visible="false">
                        <div class="row">
                            <div class="form-horizontal">
                                ...
                                <div class="col-sm-5">
                                    <asp:TextBox runat="server" class="form-control" ID="txtNama" type="text" placeholder="Enter Project" Enabled="false" Width="250"></asp:TextBox>
                                </div>
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <asp:TextBox runat="server" class="form-control" ID="Textnokontrak" type="text" placeholder="Nomor Kontrak" Width="200" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pjs-ex1-fullname" class="col-sm-3 control-label">Uraian Project</label>
                                <div class="col-sm-6">
                                    <asp:TextBox runat="server" class="form-control " ID="txtUraian" TextMode="MultiLine" type="text" placeholder="Uraian Project"  Width="300" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                            </div>
                                <div class="form-group">
