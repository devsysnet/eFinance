...
{
    public partial class Rrekapkonsolidasi : System.Web.UI.Page
    {
        ...
        protected void LoadDataGrid()
        {
            ...
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPviewRLedgerkonsolidasi", ObjGlobal.Param);
            grdAccount.DataBind();
            ...
            try
            {
                if (valid == true)
                {
                    ...
                    try
                    {
                        ObjGlobal.Param.Clear();
                        ObjGlobal.Param.Add("thn", cboYear.Text);
                        DataSet dataSet = ObjGlobal.GetDataProcedure("SPviewRLedgerkonsolidasi", ObjGlobal.Param);


                        String fileName = "rekap_konsolidasi" + ObjSys.GetNow + ".xls";
