<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPelanggaranView.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.TransPelanggaranView" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdPRUpdate" DataKeyNames="noTransPelanggaran" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdPRUpdate_PageIndexChanging" OnRowCommand="grdPRUpdate_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Pelanggaran" HeaderText="Jenis Pelanggaran" HeaderStyle-CssClass="text-center" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="center" />
                                            <asp:BoundField DataField="tglPelanggaran" HeaderText="Tgl Pelanggaran" HeaderStyle-CssClass="text-center" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}" />
                                            <asp:BoundField DataField="tot" HeaderText="Total" HeaderStyle-CssClass="text-center" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="center" />
                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Tanggal Pelanggaran <span class="mandatory">*</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-inline">
                                            ...
                                            <div class="col-sm-6">
                                                  <asp:TextBox ID="txtSkor" Width="100" Enabled="false" runat="server" CssClass="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
