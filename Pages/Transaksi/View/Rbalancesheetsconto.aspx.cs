...
{
    public partial class Rbalancesheetsconto : System.Web.UI.Page
    {
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("SPRneracascontoA", con);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPRneracascontoA", ObjGlobal.Param);
            grdAccount.DataBind();
