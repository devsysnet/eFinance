<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RcashFlow.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RcashFlow" %>
    ...
    <div id="tabGrid" runat="server">
        ...
        <div class="row">
            <div class="col-sm-12 overflow-x-table">
                <asp:GridView ID="grdAccount" DataKeyNames="no" SkinID="GridView" runat="server">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nilai Mutasi" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Saldo" SortExpression="ptd" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                            <ItemTemplate>
                                <asp:Label ID="Grup" runat="server" Text='<%# Eval("totkas") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
