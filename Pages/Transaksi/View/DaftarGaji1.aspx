<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="DaftarGaji1.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.DaftarGaji11" %>
                                            ...
                                            <asp:GridView ID="grdAccount" DataKeyNames="Nama" SkinID="GridView" runat="server" AutoGenerateColumns="false">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Kehadiran di Luar KBM" SortExpression="Kehadiran di Luar KBM" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                                                        <ItemTemplate>
                                                            <asp:Label ID="KehadirandiluarKBM" runat="server" Text='<%# Eval("KehadirandiluarKBM") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Lebih_bayar" SortExpression="Lebih_bayar" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lebih" runat="server" Text='<%# Eval("lebih") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Pinjaman_Bulanan" SortExpression="Arisan" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                                                     ...
                                                     <asp:TemplateField HeaderText="Arisan" SortExpression="Arisan" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Pinjaman" runat="server" Text='<%# Eval("PinjamanBulanan") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
