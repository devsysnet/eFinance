...
{
    public partial class Rdetailtagihanpercabang : System.Web.UI.Page
    {
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("SPRReportdetailbayarpercabang", con);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            tabelDinamis(ObjGlobal.GetDataProcedure("SPRReportdetailbayarpercabang", ObjGlobal.Param));
        }
