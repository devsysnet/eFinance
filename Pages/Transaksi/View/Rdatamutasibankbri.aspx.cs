...
{
    public partial class Rdatamutasibankbri : System.Web.UI.Page
    {
            ...
            try
            {
                if (valid == true)
                {
                    ...
                    try
                    {
                        ...
                        DataSet dataSet = ObjGlobal.GetDataProcedure("SPmutasiBRIvsSAK", ObjGlobal.Param);
        ...
        protected void btnPosting_Click(object sender, EventArgs e)
        {
            ...
            ObjGlobal.Param.Add("nocabang", cboPerwakilan.Text);
            ObjGlobal.Param.Add("nocabangunit", ObjSys.GetCabangId);
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPmutasiBRIvsSAK", ObjGlobal.Param);
            grdAccount.DataBind();
