<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPrestasiView.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.TransPrestasiView" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group" id="showProject" runat="server">
                                        ...
                                        <div class="col-sm-6">
                                             <asp:TextBox ID="cboProject" runat="server" Enabled="false" CssClass="form-control "></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Tanggal Prestasi <span class="mandatory">*</span></label>
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="dtDate" runat="server" Enabled="false" CssClass="form-control "></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtKeterangan" runat="server" Enabled="false" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
