<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Rposisikeuangan.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.Rposisikeuangan" %>
                        ...
                        <Columns>
                         <asp:TemplateField HeaderText="AKUN" SortExpression="Ket" ItemStyle-Width="50%" ItemStyle-HorizontalAlign="left">
                          ...
                          <asp:Label ID="ptd"  runat="server" Text='<%# Eval("ptd") %>'></asp:Label>
                           ...
                           <asp:TemplateField HeaderText="Bulan Lalu" SortExpression="YTD" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                          <ItemTemplate>
                          <asp:Label ID="ytd"  runat="server" Text='<%# Eval("ytd") %>'></asp:Label>
                          </ItemTemplate>
                         </asp:TemplateField> 
                          <asp:TemplateField HeaderText="Selisih" SortExpression="Selisish" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                          <ItemTemplate>
                          <asp:Label ID="ytd"  runat="server" Text='<%# Eval("selisih") %>'></asp:Label>
                          </ItemTemplate>
                         </asp:TemplateField>   
                           <asp:TemplateField HeaderText="Ratio" SortExpression="Ratio" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="right">
                          <ItemTemplate>
