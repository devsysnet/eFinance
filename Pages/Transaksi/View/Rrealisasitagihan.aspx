<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Rrealisasitagihan.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.Rrealisasitagihan" %>
                        ...
                        <Columns>
                         <asp:TemplateField HeaderText="Unit" SortExpression="unit" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Left">
                          ...
                          <asp:Label ID="ptd"  runat="server" Text='<%# Eval("rencana") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Realisasi Bln Ini" SortExpression="Realisasi Bln Ini" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                          <ItemTemplate>
                          <asp:Label ID="ytd"  runat="server" Text='<%# Eval("ptd") %>'></asp:Label>
                          </ItemTemplate>
                         </asp:TemplateField> 
                            <asp:TemplateField HeaderText="Realisasi Sd Bln ini" SortExpression="Realisasi Sd Bln ini" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="right">
                          <ItemTemplate>
