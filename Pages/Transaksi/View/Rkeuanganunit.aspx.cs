...
{
    public partial class Rkeuanganunit : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPReportRabs", ObjGlobal.Param);
            grdAccount.DataBind();
        }
            ...
            try
            {
                if (valid == true)
                {
                    ...
                    try
                    {
                        ...
                        ObjGlobal.Param.Add("tahun", cboYear.Text);
                        ObjGlobal.Param.Add("nocabang", cboCabang.Text);
                        DataSet dataSet = ObjGlobal.GetDataProcedure("SPReportRabs", ObjGlobal.Param);
