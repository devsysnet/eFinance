<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Rdetailtagihanpertgl.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.Rdetailtagihanpertgl" %>
                ...
                <div class="panel-body">
                    <div id="tabGrid" runat="server">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                       <div class="col-sm-12">
                                        ...
                                        <asp:Button runat="server" ID="Button1" CssClass="btn btn-primary" Text="Cari" OnClick="btnSearch_Click" UseSubmitBehavior="false" OnClientClick="this.disabled = true; this.value = 'Proses...';"></asp:Button>
                        ...
                        <div class="row">
                            ...
                            <span>Total :</span><asp:TextBox ID="txtTotal" runat="server" CssClass="form-control money" Width="250" Enabled="false"> </asp:TextBox>
