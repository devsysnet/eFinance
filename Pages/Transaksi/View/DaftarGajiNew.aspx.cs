...
{
    public partial class DaftarGajiNew : System.Web.UI.Page
    {
        ...
        protected void grdAccount_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if(e.CommandName == "SelectEdit")
            {
                try
                {
                    ...
                    HiddenField hdnNoKaryawan = (HiddenField)grdAccount.Rows[rowIndex].FindControl("hdnNoKaryawan");
                    ...
                    Param.Add("nama", hdnNoKaryawan.Value);

                    HttpContext.Current.Session.Add("ParamReport", Param);
                    Session["REPORTNAME"] = "RPrintSlipGajiKaryawan.rpt";
