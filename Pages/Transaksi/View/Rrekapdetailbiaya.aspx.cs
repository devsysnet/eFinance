...
{
    public partial class Rrekapdetailbiaya : System.Web.UI.Page
    {
        ...
        protected void LoadData(string cabang = "0", string thn = "")
        {
            ...
            grdSiswa.DataSource = ObjGlobal.GetDataProcedure("SPLoadDatarekapdetbiaya", ObjGlobal.Param);
            grdSiswa.DataBind();
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("SPLoadDatarekapdetbiaya", con);
                            ...
                            String fileName = "Detail_Biaya" + ObjSys.GetNow + ".xls";
