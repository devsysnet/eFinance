...
{
    public partial class Rposisikeuangan : System.Web.UI.Page
    {
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("SPviewRposisikeuangan", con);
                            ...
                            String fileName = "PosisiKeuangan_" + ObjSys.GetNow + ".xls";
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPviewRposisikeuangan", ObjGlobal.Param);
            grdAccount.DataBind();
