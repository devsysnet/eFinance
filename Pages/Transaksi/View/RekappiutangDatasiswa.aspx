<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="RekappiutangDatasiswa.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.RekappiutangDatasiswa" %>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-3">
                                     ...
                                     <div class="col-sm-3">
                                        <asp:DropDownList ID="cbojnstransaksi" runat="server" CssClass="form-control" AutoPostBack="true" ></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
