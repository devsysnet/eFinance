...
{
    public partial class Rrekapdetailpendapatan : System.Web.UI.Page
    {
        ...
        protected void LoadData(string cabang = "0", string thn = "")
        {
            ...
            grdSiswa.DataSource = ObjGlobal.GetDataProcedure("SPLoadDatarekapdetpendapatan", ObjGlobal.Param);
            grdSiswa.DataBind();
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("SPLoadDatarekapdetpendapatan", con);
                            ...
                            String fileName = "Detail_Pendapatan" + ObjSys.GetNow + ".xls";
