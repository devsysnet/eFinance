...
{
    public partial class rSaldouploadBank : System.Web.UI.Page
     {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            tabelDinamis(ObjGlobal.GetDataProcedure("ReportDataUploadBank", ObjGlobal.Param));
        }
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("ReportDataUploadBank", con);
