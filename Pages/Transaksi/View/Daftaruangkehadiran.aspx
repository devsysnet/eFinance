<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="Daftaruangkehadiran.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.Daftaruangkehadiran" %>
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="grdAccount" DataKeyNames="Nama" SkinID="GridView" runat="server" AutoGenerateColumns="false">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Total Masuk" SortExpression="ptd" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Sipil" runat="server" Text='<%# Eval("totalmasuk") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Honor Kehadiran" SortExpression="Gol." ItemStyle-Width="5%" ItemStyle-HorizontalAlign="left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Gol" runat="server" Text='<%# Eval("honor") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                 </Columns>
                                            </asp:GridView>
