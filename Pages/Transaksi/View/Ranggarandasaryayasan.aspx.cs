...
{
    public partial class Ranggarandasaryayasan : System.Web.UI.Page
    {
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("SPRanggarandasaryayasan", con);
                            cmd.Parameters.Add(new SqlParameter("@thn", cboYear.Text));
                            cmd.Parameters.Add(new SqlParameter("@jenis", cbojenis.Text));
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPRanggarandasaryayasan", ObjGlobal.Param);
            grdAccount.DataBind();
