...
{
    public partial class TransPencarianView : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            grdAssetUpdate.DataSource = ObjDb.GetRows(" SELECT a.nodeposito,a.kdTransaksi,a.nomor,a.NamaBank,a.tglDeposito,a.tglJatuhTempo,b.Jenis, CASE WHEN a.Jenis = 1 THEN 'Saldo Awal' WHEN a.jenis = 2 THEN 'Pengeluaran Bank' ELSE 'Lain-Lain' END AS jenisTransaksi FROM Tdeposito a inner join MstJenisasset b on a.jenis = b.nojnsasset where  ( kdTransaksi Like '%" + txtSearch.Text + "%' OR nomor Like '%" + txtSearch.Text + "%' )");
            grdAssetUpdate.DataBind();
        }
