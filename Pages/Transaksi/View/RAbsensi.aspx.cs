...
{
    public partial class RAbsensi : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            grdviewAbsen.DataSource = ObjGlobal.GetDataProcedure("SPLoadAbsensi", ObjGlobal.Param);
            grdviewAbsen.DataBind();
        ...
        protected void grdviewAbsen_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                string tgl = grdviewAbsen.DataKeys[e.Row.RowIndex].Value.ToString();
                GridView grdviewAbsenDetil = e.Row.FindControl("grdviewAbsenDetil") as GridView;

                ObjGlobal.Param.Clear();
                ObjGlobal.Param.Add("tgl", tgl);
                ObjGlobal.Param.Add("nocabang", cboCabang.Text);
                grdviewAbsenDetil.DataSource = ObjGlobal.GetDataProcedure("SPLoadAbsensiDetil", ObjGlobal.Param);
                grdviewAbsenDetil.DataBind();
            }
        }
    }
}