...
{
    public partial class Rrekapdetailpenerimaangereja : System.Web.UI.Page
    {
        ...
        protected void LoadData(string cabang = "0", string thn = "")
        {
            ...
            grdSiswa.DataSource = ObjGlobal.GetDataProcedure("SPLoadDatarekapdetpenerimaanGereja", ObjGlobal.Param);
            grdSiswa.DataBind();
            ...
            try
            {
                if (valid == true)
                {
                    ...
                    try
                    {
                        ...
                        DataSet dataSet = ObjGlobal.GetDataProcedure("SPLoadDatarekapdetpenerimaanGereja", ObjGlobal.Param);
