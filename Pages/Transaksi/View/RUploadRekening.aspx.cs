...
{
    public partial class RUploadRekening : System.Web.UI.Page
    {
        ...
        protected void loadData()
        {
            ...
            grdHarianGL.DataSource = ObjGlobal.GetDataProcedure("SPLoadDataRUploadRekening", ObjGlobal.Param);
            ...
            try
            {
                if (valid == true)
                {
                    ...
                    try
                    {
                        ...
                        ObjGlobal.Param.Add("nocabang", cboCabang.Text);
                        ObjGlobal.Param.Add("thn", cboYear.Text);
                        DataSet dataSet = ObjGlobal.GetDataProcedure("SPLoadDataRUploadRekening", ObjGlobal.Param);

                        String fileName = "Report_rekening" + ObjSys.GetNow + ".xls";
