...
{
    public partial class TransPenjualanObatView : System.Web.UI.Page
    {
        ...
        protected void grdReceiveUpdate_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "SelectEdit")
                {
                    ...
                    DataSet myData = ObjDb.GetRows("select * from TransPenjualanObat_h a inner join TransPenjualanObat_d b on a.noPenjualan=b.noPenjualan " +
                        "inner join mBarang c on c.noBarang = b.noBarang " +
        ...
        protected void grdReceive_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                else if (e.CommandName == "Clear")
                {
                    ...
                    Label lblDescription = (Label)grdReceive.Rows[rowIndex].FindControl("lblDescription");
