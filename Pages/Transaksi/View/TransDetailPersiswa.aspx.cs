...
{
    public partial class TransDetailPersiswa : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            ObjGlobal.Param.Add("bln1", cboMonth1.SelectedValue);
            ObjGlobal.Param.Add("thn", cboTahun.SelectedValue);
            ObjGlobal.Param.Add("noCabang", cboCabang.Text);
            tabelDinamis(ObjGlobal.GetDataProcedure("SPviewdetailpersiswa", ObjGlobal.Param));
