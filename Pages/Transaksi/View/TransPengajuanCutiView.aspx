<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="TransPengajuanCutiView.aspx.cs" Inherits="eFinance.Pages.Transaksi.View.TransPengajuanCutiView" %>
                                    ...
                                    <asp:GridView ID="grdBarang" DataKeyNames="nocuti" SkinID="GridView" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdBarang_PageIndexChanging" OnRowCommand="grdBarang_RowCommand" >
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="" HeaderStyle-CssClass="text-center" ItemStyle-Width="5%">
                                                ...
                                                <ItemTemplate>
                                                    <div class="text-center">
                                                        <asp:Button Visible="false" ID="btnSelectDel" runat="server" class="btn btn-xs btn-labeled btn-danger" Text="Hapus" CommandName="SelectDelete" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>' CausesValidation="false" />
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                ...
                                <div class="col-sm-12">
                                    <div class="panel">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="dttgl" placeholder="Tanggal Pinjam"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <asp:TextBox runat="server" CssClass="form-control" Enabled="false" ID="dttgldr" placeholder="Tanggal Pinjam"></asp:TextBox>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label for="pjs-ex1-fullname" class="col-sm-3 control-label">Sampai Tanggal</label>
                                            <div class="col-sm-2">
                                                <asp:TextBox runat="server" CssClass="form-control" Enabled="false" ID ="dttglsd" placeholder="Tanggal Pinjam"></asp:TextBox>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label for="pjs-ex1-fullname" class="col-sm-3 control-label">Uraian</label>
                                            <div class="col-sm-2">
                                                <asp:TextBox runat="server" CssClass="form-control" Enabled="false" type="text" ID="txtUraian" placeholder="Uraian" TextMode="MultiLine" Width="300"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="text-center">
                                                    <asp:Button ID="btnSimpan" runat="server"  Visible="false" CssClass="btn btn-primary" Text="Save" OnClick="btnSimpan_Click" />
