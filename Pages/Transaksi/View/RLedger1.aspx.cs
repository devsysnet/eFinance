...
{
    public partial class RLedger1 : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            ObjGlobal.Param.Add("thnajaran", cbothnajaran.Text);
            ...
            grdAccount.DataSource = ObjGlobal.GetDataProcedure("SPviewRLedgerdetail1", ObjGlobal.Param);
            grdAccount.DataBind();
            ...
            try
            {
                if (valid == true)
                {
                    using (SqlConnection con = new SqlConnection(ObjDb.ConDb()))
                    {
                        ...
                        try
                        {
                            cmd = new SqlCommand("SPviewRLedgerdetail1", con);
