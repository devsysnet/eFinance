<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebMaster.Master" AutoEventWireup="true" CodeBehind="UnPostingharianKas.aspx.cs" Inherits="eFinance.Pages.Transaksi.Posting.UnPostingharianKas" %>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-11">
                                    <asp:DropDownList runat="server" CssClass="form-control" ID="cboAccount" AutoPostBack="true"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
