...
{
    public partial class unPostingabsensicabang : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            cboMonth.DataSource = ObjGlobal.GetDataProcedure("SPLoaddataunposHRD", ObjGlobal.Param);
            ...
            ObjGlobal.Param.Clear();
            ObjGlobal.Param.Add("nocabang", ObjSys.GetCabangId);
            cboYear.DataSource = ObjGlobal.GetDataProcedure("SPLoaddataunposHRDThn", ObjGlobal.Param);
        ...
        protected void btnPosting_Click(object sender, EventArgs e)
        {
            ...
            ObjGlobal.ExecuteProcedure("SPUnpostHRDCabang", ObjGlobal.Param);
            LoadData();
