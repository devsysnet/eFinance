...
{
    public partial class PostingAbsenAll : System.Web.UI.Page
    {
        ...
        protected void btnPosting_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (valid == true)
                {
                    ...
                    ObjGlobal.ExecuteProcedure("SPProsesBulananGajiALL", ObjGlobal.Param);
                    ObjGlobal.ExecuteProcedure("SPProsesJurnalGajiALL", ObjGlobal.Param);
